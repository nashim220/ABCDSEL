...
//Edited : Abhishek, Date :- 04/15/2016
...
public class ValidateCompanyProfileInformationObjects 
{
...
//To  get Locale Elements Link
  public List<WebElement> fn_getLocaleElements(WebDriver driver,WebDriverWait webWait) throws InterruptedException
	{
		List<WebElement> LocaleElements = driver.findElements(By.xpath("//*[@id=\"ajaxcontent\"]/form/div[1]"));
