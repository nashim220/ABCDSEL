/*
 ...
 Date       		:	08/31/2015
 Modified Date		:	04/18/2015
 Version Information:	Version 1.5
 ...
 Version Changes 1.1:	1. Modified the identifiers for couple of objects.
				 ...
				 1.5:	1. Added identifiers for 'Cash Credits', 'Service Credits' links and 'New' button
...
public class PaymentDetailsFinancialReport
{
	...
	//to identify the Cash Credits link
	...
	//to identify the Service Credits link
	public WebElement fn_clickServiceCredits(WebDriver driver, WebDriverWait webWait) throws InterruptedException
	{
		webElement = webWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"bottomPaneTabBar\"]/ul/li[6]/a")));
		return webElement;
	}
	...
	{
		webElement = webWait.until(ExpectedConditions.elementToBeClickable(By.partialLinkText("New")));
		return webElement;
	}
	...
	//to identify New Button on the Service Credits Page
