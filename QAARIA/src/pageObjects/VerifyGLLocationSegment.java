...
public class VerifyGLLocationSegment 
{
	...
	//to identify the Preview Report! button
	public By fn_clickHereToViewLargeReport() throws InterruptedException
	{
		return By.linkText("Click here to view this large report.");
	}
	...
	//to identify the Message after clicking the Generate Statement Button. 
	public WebElement fn_geTableDetails(WebDriver driver, WebDriverWait webWait) throws InterruptedException
	{
		webElement = webWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table[2]/tbody/tr[1]")));
		return webElement;
	}	
	//to identify the Message after clicking the Generate Statement Button. 
	public WebElement fn_geTableDetail(WebDriver driver, WebDriverWait webWait) throws InterruptedException
	{
		webElement = webWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table[2]/tbody")));
		return webElement;
	}
