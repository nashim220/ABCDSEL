/*
 Author     		:	Abhishek
 Class Name			: 	Cls_Validate_ContractsSettings
 Purpose     		: 	Purpose of this file is :
						1. To Validate Contracts Settings.
...
public class Cls_Validate_ContractsSettings extends VerificationMethods
{

WebElement webElement;
public static WebDriver driver;
	
	public static String strTestCaseName = "Cls_Validate_ContractsSettings";
		...
		@Test(dataProvider="objectTestData", description="Cls_ValidateContractsSettings")
	    public void ValidateCountries(String strSheetName, String AccNum) throws Exception
	    {
		    ...
		    Log.info("Validating Contracts Settings");
		   ...
		   try
			{
			    ...
			    objCountries.fn_ContractsSettingsLink(driver, webWait).click();
			    Thread.sleep(500);
	    ...
	    public Object[][] data() throws DataDrivenFrameworkException
	    {
	        ...
	        return objUtils.data1("TestCaseDetails", "Cls_ValidateContractsSettings");
	    }
