...
==============================================================
 ...
 Date       		:	06/02/2015
 Modified Date		:	01/11/2016, 12/04/2015, 10/28/2015, 10/24/2015, 09/08/2015, 08/28/2015, 08/06/2015, 07/01/2015
 Version Information:	Version 8.0
 
 PreCondition 		:	None
 Test Steps 		:	None
 
 Version Changes 2.0:	1. Parameterized the Snapshot feature to avoid over-writing of snapshots.
 Version Changes 3.0:	1. Added custom method to get string data and then convert it to string in Big Decimal format.
 Version Changes 4.0:	1. Added custom methods by Joe & Aashish to handle the Reports frame.
 Version Changes 5.0:	1. Added custom methods 'fn_ReportsFileDownload' & 'fn_SetChromeDriverProperties' for handling
 							the chrome browser capabilities & for handling Reports Download prompt.
 Version Changes 5.1:	1. Modified the "fn_ReadGeneratedReport" method to suit the typical reports requirements. 
 Version Changes 6.0:	1. Added function "fn_GenerateReport" to generate the reports of category SGAS/Standard
 Version Changes 6.1:	1. Modified function "fn_ConvertStringToBigDecimal" to handle null strings.
 Version Changes 7.0:	1. Added function "fn_getPreviousDate" to generate previous date.
 Version Changes 7.1:	1. Modified Function "writeexcel_InternalData" to write file in append mode and use Array's Column Index.
 Version Changes 8.0:	1. Added function "fn_getDateFormatted" to get date of type "DD-MMM-YYYY" converted to "YYYY-MM-DD" & "MM-DD-YYYY".
...
*/
		 public static String fn_getDateFormatted(String strDate, String strDateFormat){
...
*/    		
		public String fn_ConvertStringToBigDecimal(String strConvertBigDeci) throws Exception
		{
			...
			bdValue.setScale(2, BigDecimal.ROUND_DOWN);
			
			DecimalFormat objDecimalForm = new DecimalFormat("0.00");
			objDecimalForm.setMaximumFractionDigits(2);
