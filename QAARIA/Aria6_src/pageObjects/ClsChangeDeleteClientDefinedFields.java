...
public class ClsChangeDeleteClientDefinedFields {
	...
	{
		webElement = webWait.until(ExpectedConditions.elementToBeClickable(By.partialLinkText(acct_num)));
		return webElement;
	}
	...
	public WebElement fn_SerachFields(WebDriver driver,WebDriverWait webWait) throws InterruptedException
	{
