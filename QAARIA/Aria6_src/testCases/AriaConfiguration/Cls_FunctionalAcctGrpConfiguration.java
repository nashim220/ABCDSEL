...
public class Cls_FunctionalAcctGrpConfiguration {
	...
	public void fn_FunctionalAcctGrpConfiguration(String  sTestCaseName, String strTestGrpName, String strTestClientGrpID, String strTestNotificationTempGrp) {
		...
		try {
			...
			String strSeqNum = driver.findElement(By.xpath("//label[text()='Starting Sequence Number']/following::input")).getAttribute("value");
			...
			if (strGrpName.equalsIgnoreCase(strTestGrpName) && strClientGrpID.equalsIgnoreCase(strTestClientGrpID) && strSeqNum.contains("300000") && strNotificationTempGrp.equalsIgnoreCase(strTestNotificationTempGrp) ){
