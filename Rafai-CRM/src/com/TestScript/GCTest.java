...
public class GCTest {
    ...
    public   void setup() throws Exception {
	 ...
	 public void ValidateGCDetails(){
		 ...
		 System.out.println("Step 3 : Susscessfully entered  in to GC page ' Passed' : " );
		 Reporter.log("Step 3 : Susscessfully entered  in to GC page ' Passed' : " ); 
		 
	 	String ExpectedText = "Main Menu";
		String ActualText = objGCPage.GetMainMenuText();		
	    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	    
		 if(ActualText.equals(ExpectedText))
			{				
				System.out.println("Success !! Correct Validation is Navigate to  Categary. i.e. " +ExpectedText);
				Reporter.log("Success !! Correct Validation is Navigate to  Categary. i.e. " +ExpectedText);
			
			}
			else
			{			
				System.out.println("Failure !! Incorrect Validation is Navigate to  Categary.. Expected :" + ExpectedText + "\n"+"Actual :" +ActualText);
				Reporter.log("Failure !! Incorrect Validation is Navigate to  Categary.. Expected :" + ExpectedText + "\n"+"Actual :" +ActualText);			
				AssertFailedCount++;
			}
		 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		 obSelfun.SelectValueFromDropdownList("id","ddllr_coll_typ2coll_typ","GODOWN");
