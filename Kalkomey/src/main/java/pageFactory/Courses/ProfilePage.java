...
public class ProfilePage 
{
	 ...
	 */ 	
		...
		// Boat - GA (DNR Number )
		@FindBy(xpath="//label[contains(.,'DNR Number ')]")
		public WebElement DNR_NumberTitle; 
		
		@FindBy(css="#customer_id")
		public WebElement DNR_NumberField; 
		
		@FindBy(css=".controls>p")
		public WebElement DNR_NumberFieldText; 
		
		@FindBy(css=".alert.alert-block.alert-error>ul>li")
		public WebElement DNR_NumberValidation;
