...
public class CourseContentsAndQuizzesAllTest 
{
	...
	*/ 
	...
	private void Contents_Navigation(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_ResumeLinkWorkingAsExpected(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_ContinueLeftOffButtonWorkingAsExpected(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 54 : On Unit page, waiting for timer to over and then clicking on Next Button"); 
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_VerifyUnitTopicPageNumber(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 3 : On Contnets page, verify that Unit/Topic/Page number correctly displayed on contents page"); 
			...
			for (int i=1;i<3;i++)
			{
				String ExpectedText = "Unit 1 of 9";
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_NavigateNextPreviousPages(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		System.out.println("Step 3 : On Contnets page, verify that user can navigate to 'Next' & 'Previous' pages");
		Reporter.log("Step 3 : On Contnets page, verify that user can navigate to 'Next' & 'Previous' pages"); 
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_NextButton_Timer_Tooltip(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_IntroductionPage(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_Questionnaire1(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_Questionnaire2(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_ResumeQuiz(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_QuizResultFail(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_QuizResultPass(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_QuizResultFail_SeeCritiquebutton(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	Reporter.log("Step 8 : Clicking 'Back to the Quiz Results' button");
		...
		tempurl2="https://qa1.hunter-ed.com/exam/quiz/700017413/?override_reset=1";
		SeleniumFunc.ClickOnElement("css", "#prev_text a");
		Thread.sleep(4000);
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_QuizResultFail_Previousbutton(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Quiz_QuizResultPass_NextPreviousButtons(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_course_outline(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_ContentVerification(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 2 : On Contents page, verifying Page Header, Introduction Text, Units, Exams related text"); 
			...
			//Verifying Page header
				...
				String expected = "Arkansas Hunter Ed Course";
			...
			//Verifying Introduction text
				...
				String expected1 = "If you are returning to the course, the unit/topic where you need to resume study is already “opened” for you to click. You also may click on a unit/topic in the list below to access a page you've already completed.";

				if(actual.contains(expected) && actual.contains(expected1))
				{
				...
				{
					System.out.println("Failure !! Introduction text is incorrect . Expected is : " + expected + expected1  + "\n" + "Actual is : " + actual);
					Reporter.log("Failure !! Introduction text is incorrect . Expected is : " + expected + expected1  + "\n" + "Actual is : " + actual); 
					AssertFailedCount++;
				}	
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Contents_TimedCourseVerification(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		System.out.println("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL_Hunter +Constants.State_Hunter_Timed);
		Reporter.log("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL_Hunter +Constants.State_Hunter_Timed); 
		...
		System.out.println("Step 6 : Navigating back to Contents page and Expanding Unit 1, Expanding Topic 1 , clicking on Page 1 link");
		Reporter.log("Step 6 : Navigating back to Contents page and Expanding Unit 1, Expanding Topic 1 , clicking on Page 1 link"); 
