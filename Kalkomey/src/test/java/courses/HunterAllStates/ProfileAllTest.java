...
public class ProfileAllTest 
{
	...
	*/ 
	...
	private void Profile_UIElementVerification(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_YourHunterEdAccountSection(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ResetPassword(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_Edit1(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_Edit2(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_DefaultValues(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForInvalidEmail(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForInvalidZip(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForInvalidPhone(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForMandatoryFields(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			ExpectedURL = Constants.ApplicationURL + Constants.State + "/sign-up/details/";
			ActualURL = SeleniumFunc.ToGetCurrentPageUrl();
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_HideUnhidePhysicalAddress(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_RegionLocalityFieldLabelChange(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	private void Profile_CountryDropdown_Values() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			register.RegisterAsNewUser(username, "January", "5", "1990", emailaddress);
			Thread.sleep(8000);
