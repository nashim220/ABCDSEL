...
public class CourseContentsAndQuizzesTest 
{
	...
	private void Contents_NavigateNextPreviousPages() throws Exception
	{
		...
		Reporter.log("Step 3 : On Contnets page, verify that user can navigate to 'Next' & 'Previous' pages"); 
			...
			Thread.sleep(15000);
				...
				String ExpectedText = "Unit 1 of 9";
				String ActualText= SeleniumFunc.GetElementText("css", "#course_controls > li.control-center > ul > li:nth-child(1) > b").trim();
				
				String ExpectedText2 = "Topic 1 of 4";
				String ActualText2= SeleniumFunc.GetElementText("css", "#course_controls > li.control-center > ul > li:nth-child(2) > b").trim();
				
				String ExpectedText3 = "Page 2 of 2";
				String ActualText3= SeleniumFunc.GetElementText("css", "#course_controls > li.control-center > ul > li:nth-child(3) > b").trim();
	...
	*/ 
	 ...
	 * */ 
	@Test
	private void Video_Transcript_HT() throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Hunter + Constants.State_Video);
			PageHeader header = new PageHeader(driver); 
		...
		Reporter.log("Step 3 : Clicking on 'Complete the Application' button");
			...
			Reporter.log("Step 4 : Go to Video Transcript page" );
				...
				SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Hunter + Constants.State_Video + "/course_content/course/201039/section/700092280");
				Thread.sleep(5000);
