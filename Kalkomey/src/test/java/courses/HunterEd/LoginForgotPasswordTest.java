...
public class LoginForgotPasswordTest 
{
	...
	*/ 
	...
	private void Login_UIElementVerification() throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to Login page : " + Constants.ApplicationURL_Hunter + "/site/login");
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ApplicationURL_Hunter + "/site/login"); 
	...
	*/ 
	...
	private void Login_LoginSuccessful() throws Exception
	{
		...
		Reporter.log("Pre-requisite : Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Hunter + "/register/create");
	...
	*/ 
	...
	private void Login_RestrictedPages(String restricted_pages) throws Exception
	{
		...
		Reporter.log("Step 1 : Trying to access Restricted Pages and verifying whether user is navigated to Home page or not"); 
			...
			restricted_pages = Constants.ApplicationURL_Hunter + restricted_pages;
			SeleniumFunc.ToGoToUrl(restricted_pages);
			
				if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Hunter.subSequence(5,Constants.ApplicationURL_Hunter.length())))
				{
	...
	*/ 
	...
	private void Login_Logout() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying whether user is logged out successfully or not"); 
				...
				if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Hunter.subSequence(5,Constants.ApplicationURL_Hunter.length())+ "/site/logout"))
				{
	...
	private void Login_PasswordResetEmail() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether Password Reset Email sent to user or not"); 
			...
			String ExpectedMessageBody =
					"Dear test" + "\n" + 
					"This e-mail contains instructions on resetting your password for the online course at Hunter Ed.com."  + "\n" +
	...
	*/ 
	...
	private void Login_PasswordResetEmail() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether Password Reset Email sent to user or not"); 
			...
			String ExpectedMessageBody =
					"Dear test" + "\n" + 
					"The following instructions will help you reset your password for your online course at hunter-ed.com."  + "\n" +
	...
	*/ 
	...
	private void Login_SessionTimeout() throws Exception
	{
		...
		Reporter.log("Pre-requisite : Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Hunter + Constants.State_Hunter);
			PageHeader header = new PageHeader(driver); header.Register.click();
			//For few States , closing modal dialog present on Registration page
			if(SeleniumFunc.IsElementPresent("id", "wait-right-there"))
				{
		...
		Reporter.log("Step 1 : Do not do any activity for 25 mins and refreshing page after 25 mins"); 
			...
			String expectedurl = Constants.ApplicationURL_Hunter + "/site/login/";
