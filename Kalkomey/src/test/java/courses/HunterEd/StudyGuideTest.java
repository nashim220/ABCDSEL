	...
	private void StudyGuide_Content_Verification() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying contents on 'Study Guide' page");
			...
			//Verifying about sections i.e. title text, body, Learn More button, Register for the Course button
				...
				String expectedtext2 = "in the timed Arkansas Hunter Ed Course. Feel free to look around, but";
				String expectedtext3 = "need to register to begin progress toward getting your Hunter Education Certificate.";
				//expectedtext = "You are looking at a preview of what’s in the timed Arkansas Hunter Ed Course. Feel free to look around, but you’ll need to register to begin progress toward getting your Hunter Education Certificate.";
				actualtext = studyguide.About_PageHeaderText.getText().trim();
				
				if(actualtext.startsWith(expectedtext1) && actualtext.endsWith(expectedtext3) && actualtext.contains(expectedtext2))
				{
					System.out.println("-- Success !! About section has correct text");
					Reporter.log("-- Success !! About section has correct text");
				}
				else
				{
					System.out.println(" -- Failure !! About section has incorrect text");
					Reporter.log("-- Failure !! About section has incorrect text");
					AssertFailedCount++;
				}
		 ...
		 // Verifying content section title
				expectedtext = "Study Guide for Hunter Education Certificate";
		...
		Reporter.log("Step 4 : Clicking on 'Learn More' button");
			...
			expectedtext = Constants.ApplicationURL_Hunter.substring(5) + Constants.State_Hunter_Timed;
			actualtext = driver.getCurrentUrl();
		...
		Reporter.log("Step 5 : Clicking on 'Register for the Course' button");
			...
			expectedtext = Constants.ApplicationURL_Hunter.substring(5) + Constants.State_Hunter_Timed + "/sign-up/";
			actualtext = driver.getCurrentUrl();
