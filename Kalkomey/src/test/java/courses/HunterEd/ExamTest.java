...
public class ExamTest 
{
	...
	*/ 
	@Test
	private void PracticeExam_UIElementVerification() throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 5 : Verifying UI elements on Practice Exam page");
			...
			*/
			String expectedtext = "Before taking the Final Exam, you should take a Practice Exam to gauge your knowledge of the material presented. You may take a Practice Exam as many times as you wish. If you prefer, you may skip to the Final Exam.";
			...
			*/
			...
			//verifying 'Go to the Final Exam' button
			if(practiceexam.FinalExam.getText().trim().contains("Go to Final Exam"))
			{
				System.out.println("-- 'Go to the Final Exam' button is present"  );
				Reporter.log("-- 'Go to the Final Exam' button is present");
			}
			else
			{
				System.out.println("-- 'Go to the Final Exam' button is not present"  );
				Reporter.log("-- 'Go to the Final Exam' button is not present ");
				AssertFailedCount++;
			}
	...
	*/ 
	@Test
	private void PracticeExam_UI_Buttons() throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 5 : On Pracice Exam page, clicking 'Take Practical Exam' button");
			...
			String expectedtext = "Practice Exam / Question 1 of 50";
			...
			{
				System.out.println("-- On click to Take Practical Exam button , user is NOT navigated to Question 1 page and navigated to : " + driver.getCurrentUrl()  );
				Reporter.log("-- On click to Take Practical Exam button , user is NOT navigated to Question 1 page and navigated to :" + driver.getCurrentUrl());
				AssertFailedCount++;
			}
		...
		Reporter.log("Step 8 : Clicking on 'Final Exam' button");
			...
			//verifying page header
			if(practiceexam.PageTitle.getText().trim().equals("Final Exam"))
			{
	 ...
	 * */ 
	@Test
	private void PracticeExam_ResumeExam() throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 5 : On Pracice Exam page, clicking 'Continue the Practice Exam'' button");
			...
			practiceexam.Next.click();
			Thread.sleep(5000);

			actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			expectedtext = "Practice Exam / Question 1 of 50";
			...
			{
				System.out.println("-- On click to Continue the Practice Exam button , user is NOT navigated to Question 1 page and navigated to : " + driver.getCurrentUrl()  );
				Reporter.log("-- On click to Continue the Practice Exam button , user is NOT navigated to Question 1 page and navigated to :" + driver.getCurrentUrl());
				AssertFailedCount++;
			}
	 ...
	 * */ 
	@Test
	private void PracticeExam_QuitExam() throws Exception
	{
		System.out.println("====" + "\n" +
	...
	private void FinalExam_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying UI elements on Final Exam page");
			...
			if(practiceexam.PageTitle.getText().trim().equals("Final Exam"))
			{
				System.out.println("-- Page header is correct i.e. Final Exam"  );
				Reporter.log("-- Page header is correct i.e. Final Exam");
			}
			else
			{
				System.out.println("-- Page header is incorrect"  );
			...
			//verifying rules
			String expectedtext = "Before taking the Final Exam, you can take a Practice Exam to gauge your knowledge of the material presented. You may take a Practice Exam as many times as you wish to prepare." + "\n" + 
								  "60 questions (multiple choice)"+ "\n" +
								  "80% to pass" + "\n" + 
								  "Exam is graded as soon as you finish" + "\n" + 
								  "Pay for course AFTER you pass. No pass? No pay!" + "\n" + 
								  "After you pass the Final Exam:" + "\n" + 
								  "Complete your payment information." + "\n" + 
								  "Print your Online Course Completion Voucher from your computer. Or, have it sent to your email address in PDF format.";
			...
			if(finalexam.FinalExam.getText().trim().contains("Begin the Final Exam"))
			{
				System.out.println("-- 'Begin the Final Exam' button is present"  );
				Reporter.log("-- 'Begin the Final Exam' button is present");
			}
			else
			{
				System.out.println("-- 'Begin the Final Exam' button is not present"  );
				Reporter.log("-- 'Begin the Final Exam' button is not present ");
				AssertFailedCount++;
			}
	...
	private void FinalExam_UI_Buttons() throws Exception
	{
		...
		Reporter.log("Step 6 : On Final Exam page, clicking 'Begin Final Exam' button");
			...
			String actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			String expectedtext = "Final Exam / Question 1 of 50";
	...
	private void FinalExam_ResumeExam() throws Exception
	{
		...
		Reporter.log("Step 6 : Log out and login again to application");
			...
			//verifying page header
			if(finalexam.PageTitle.getText().trim().equals("Final Exam") )
			{
				System.out.println("-- User is navigated to Final Exam"  );
				Reporter.log("-- User is navigated to Final Exam");
			}
			...
			{
				System.out.println("-- 'Continue Final Exam' button is present"  );
				Reporter.log("-- 'Continue Final Exam' button is present");
			}
			else
			{
				System.out.println("-- 'Continue Final Exam' button is NOT present" );
				Reporter.log("-- 'Continue Final Exam' button is NOT present");
				AssertFailedCount++;
			}
		
		
		System.out.println("Step 7 : On Final Exam page, clicking 'Continue Final Exam' button" );
		Reporter.log("Step 7 : On Final Exam page, clicking 'Continue Final Exam' button");
			...
			String actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			expectedtext = "Final Exam / Question 2 of 50";
					
			//verifying url
			if(actualtext.equals(expectedtext))
			{
				System.out.println("-- On click to the 'Continue Final Exam' button, user is navigated to Question 2 page"  );
				Reporter.log("-- On click to  the 'Continue Final Exam' button , user is navigated to Question 2 page");
			}
			else
			{
				System.out.println("-- On click to the 'Continue Final Exam' button, user is navigated to Question 2 page and navigated to : " + driver.getCurrentUrl()  );
				Reporter.log("-- On click to the 'Continue Final Exam' button , user is navigated to Question 2 page and navigated to :" + driver.getCurrentUrl());
				AssertFailedCount++;
			}
	...
	private void FinalExam_ResultsFail() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.AdminURL);
			keadmin.StudentSearchAndActivity(username, "Hunter", "Fast Forward Fail");
		...
		Reporter.log("Step 3 : Verifying Final Exam result page when result = Fail");
			...
			//verifying header
			String expectedtext = "Final Exam";
			...
			expectedtext = "See a Critique of Your Final Exam Results";
	...
	private void FinalExam_ResultsFail_SeeCritique() throws Exception
	{
		...
		System.out.println("Step 3 : Click on 'See a Critique of Your Final Exam Results' button" );
		Reporter.log("Step 3 : Click on 'See a Critique of Your Final Exam Results' button");
		...
		Reporter.log("Step 4 : Verifying Critique page");
			...
			//verifying page header
			String actualtext = SeleniumFunc.GetElementText("css", "div.page-header h1");
			String expectedtext = "Final Exam Critique";
	...
	private void FinalExam_ResultsPass() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Final Exam result page when result = Pass");
			...
			expectedtext = "Next, get your Online Course Completion Voucher";
			actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] h2");
	...
	/* Test 14: 
	 *  Final Exam : To verify max exam attempts for Today's Hunter in Alabama Course
	 * */ 
	@Test
	private void FinalExam_MaxAttemptAL() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 14 :  Final Exam : To verify max exam attempts for Today's Hunter in Alabama Course"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 14 :  Final Exam : To verify max exam attempts for Today's Hunter in Alabama Course "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			register.EnterSSNNumber("254565859");
			register.ClickOnCreateAccount();
			Thread.sleep(6000);
		...
		System.out.println("Step 3 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page");
		Reporter.log("Step 3 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			for (int i=1;i<3;i++)
			{
				...
				//Go back to Contents page
				SeleniumFunc.ToGoToUrl(ContentPageUrl);
				System.out.println("Navigated to : "+ContentPageUrl);
				...
				System.out.println("Step 4 : Verifying Final Exam result page when result = Fail" );
				Reporter.log("Step 4 : Verifying Final Exam result page when result = Fail");
					...
					//expectedtext = "You have now failed the Final Exam 1 time(s). You are allowed a total of 2 failures before you fail the entire course and will have to take the entire course again.";
					expectedtext = "You have now failed the Final Exam " + i + " time(s). You are allowed a total of 2 failures before you fail the entire course and will have to take the entire course again.";
					actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] p:nth-of-type(1)");
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! user is allowed to attemp exam 2 times");
						Reporter.log("-- Success !! user is allowed to attemp exam 2 times");
					}
					else
					{
						System.out.println("-- Failure !! user is NOT allowed to attemp exam 2 times . Expected : " + expectedtext + "Actual : "+ actualtext);
						Reporter.log("-- Failure !! user is NOT allowed to attemp exam 2 times . Expected : " + expectedtext + "Actual : "+ actualtext);
						AssertFailedCount++;
					}
					
					if(i<2)
					{
						System.out.println("-- Attempting exam " + (i+1) + " time");
						Reporter.log("-- Attempting exam " + (i+1) + " time");
						
						//Clicking on Begin the Certification Exam
						SeleniumFunc.ClickOnElement("css", "#next_text a");
						Thread.sleep(5000);
	...
	/* Test 15: 
	 *   Final Exam : To verify max exam attempts for Today's Hunter in Arkansas Course
	 * */ 
	@Test
	private void FinalExam_MaxAttemptAR() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 15 :   Final Exam : To verify max exam attempts for Today's Hunter in Arkansas Course"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 15 :   Final Exam : To verify max exam attempts for Today's Hunter in Arkansas Course "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Hunter + "/arkansas");
	...
	/* Test 16: 
	 *    Final Exam : To verify max exam attempts for Today's Hunter in Illinois Course
	 * */ 
	/*@Test
	private void FinalExam_MaxAttemptIL() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 16 :   Final Exam : To verify max exam attempts for Today's Hunter in Illinois Course"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 16 :    Final Exam : To verify max exam attempts for Today's Hunter in Illinois Course "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Hunter + "/illinois");
			Thread.sleep(4000);
			if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
			{
				header.Logout_Handgun.click();
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			for (int i=1;i<3;i++)
			{
				...
				Reporter.log("Step 3 : Verifying Final Exam result page when result = Fail");
					...
					//verifying header
					String expectedtext = "Field Day Qualification Exam";
					String actualtext = SeleniumFunc.GetElementText("css", "div.page-header h1");
					...
					expectedtext = "You have now failed the Field Day Qualification Exam " + i + " time(s). You are allowed a total of 2 failures before you fail the entire course and will have to take the entire course again.";
					
					actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] p:nth-of-type(1)");
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! user is allowed to attemp exam 2 times. Expected : " + expectedtext + "Actual : "+ actualtext);
						Reporter.log("-- Success !! user is allowed to attemp exam 2 times. Expected : " + expectedtext + "Actual : "+ actualtext);
					}
					else
					{
						System.out.println("-- Failure !! user is NOT allowed to attemp exam 2 times . Expected : " + expectedtext + "Actual : "+ actualtext);
	...
	private void FinalExam_MaxAttemptIL() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
				...
				Reporter.log("Step 4 : Verifying Final Exam result page when result = Fail");
					...
					expectedtext = "You have now failed the Field Day Qualification Exam 1 time(s). You are allowed a total of 2 failures before you fail the entire course and will have to take the entire course again.";
					actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] p:nth-of-type(1)");
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! user is allowed to attemp exam 1 times");
						Reporter.log("-- Success !! user is allowed to attemp exam 1 times");
					}
					else
					{
						System.out.println("-- Failure !! user is NOT allowed to attemp exam 2 times . Expected : " + expectedtext + "Actual : "+ actualtext);
						...
						System.out.println("-----Attempting exam 2 time------");
						Reporter.log("-----Attempting exam 2 time------");
						...
						System.out.println("Step 5 : Verifying Final Exam result page when result = Fail for Second attempt!!" );
						Reporter.log("Step 5 : Verifying Final Exam result page when result = Fail for Second attempt!!");
							
							//verifying header
							String expectedtext3 = "Field Day Qualification Exam";
							String actualtext3 = SeleniumFunc.GetElementText("css", "div.page-header h1");
							
							if(actualtext3.equals(expectedtext3))
							{
								System.out.println("-- Success !! Correct page header i.e. " + actualtext3);
								Reporter.log("-- Success !! Correct page header i.e. " + actualtext3);
							}
							else
							{
								System.out.println("-- Failure !! incorrect page header i.e. " + actualtext3);
								Reporter.log("-- Failure !! incorrect page header i.e. " + actualtext3);
								AssertFailedCount++;
							}
							
						
							
							String expectedtext2 = "You have now failed the Field Day Qualification Exam a total of 1 time(s), which means that you have failed the course. In order to pass the course at this point, you will need to re-register for the course again and start from the very beginning.";
							String actualtext2 = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] p:nth-of-type(1)");
							...
							{
								System.out.println("-- Failure !! user is NOT allowed to attemp exam 2 times . Expected : " + expectedtext2 + "Actual : "+ actualtext2);
								Reporter.log("-- Failure !! user is NOT allowed to attemp exam 2 times . Expected : " + expectedtext2 + "Actual : "+ actualtext2);
								AssertFailedCount++;
							}
