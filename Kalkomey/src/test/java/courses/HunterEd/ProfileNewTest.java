...
public class ProfileNewTest 
{
	...
	*/ 
	...
	private void Profile_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			register.RegisterAsNewUser(username,"January", "5", "1990", emailaddress,"clarion@123", "clarion@123");
			Thread.sleep(8000);
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Hunter);
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ProfilePage_Hunter); 
		...
		System.out.println("Step 4 : Verifying presence sections : 'Your Hunter Ed Account' and 'Account Information' ");
		Reporter.log("Step 4 : Verifying presence sections : 'Your Hunter Ed Account' and 'Account Information' "); 	
			
			if(SeleniumFunc.GetElementText("css", "div#main section:nth-of-type(1) h2").equals("Your Hunter Ed Account"))
			{
				
				System.out.println("Success !! 'Your Hunter Ed Account' section is present");
				Reporter.log("Success !! 'Your Hunter Ed Account' section is present"); 
			}
			else
			{
				System.out.println("Failure !! 'Your Hunter Ed Account' section is NOT present");
				Reporter.log("Failure !! 'Your Hunter Ed Account' section is NOT present"); 
				AssertFailedCount++;
			}
	...
	/* Test 2: 
	 * Verify that 'Your Hunter Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address
	*/ 
	@Test
	private void Profile_YourHunterEdAccountSection() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Verify that 'Your Hunter Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Verify that 'Your Hunter Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Verifying 'Your Hunter Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address");
		Reporter.log("Step 3 : Verifying 'Your Hunter Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"); 
			...
			if(SeleniumFunc.GetElementText("css", "div#main section:nth-of-type(1) h3").trim().equals("Test Ke-testing"))
			{
	...
	*/ 
	...
	private void Profile_ResetPassword() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying user is navigated to '/register/edit' page and proper confirmation message is dispalyed on that page");
			...
			if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Hunter.subSequence(5,Constants.ApplicationURL_Hunter.length())+ "/register/edit/"))
			{
	...
	*/ 
	...
	private void Profile_HideUnhidePhysicalAddress() throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Hunter);
		Reporter.log("Step 2 : Navigate to Profile page  : " + Constants.ProfilePage_Hunter); 
	...
	*/ 
	...
	/* Test 13: 
	 * Verify that all countries should be displayed under country dropdown
	*/ 
	@Test
	private void Profile_CountryDropdown_Values() throws Exception
	{
		...
		/* Test 14: 
		 * Verify that Profile Name is Editable Until Pay
		*/ 
		@Test
		private void ProfileEdit() throws Exception
		{
			System.out.println("====" + "\n" +
					"Test 14 : Verify that Profile Name is Editable Until Pay"  + "\n" +
		 			"====");
			Reporter.log("====" + "\n" +
		 			  "Test 14 : Verify that Profile Name is Editable Until Pay"  + "\n" +
				 	  "====");	
			...
			System.out.println("Step 2 : Go to profile and edit  and save");
			Reporter.log("Step 2 : Go to profile and edit  and save"); 
			...
			System.out.println("Step 3 : Navigating to Profile page and verifying Student can make changes to his/her name in the profile until student has paid.");
			Reporter.log("Step 3 : Navigating to Profile page and verifying Student can make changes to his/her name in the profile until student has paid.");
			
				SeleniumFunc.ToGoToUrl(Constants.ProfilePage_Hunter);
				
				Thread.sleep(4000);
				
				if(SeleniumFunc.GetAttributeValue("id", "StudentModel_first_name", "value").equals(firstname))
				{
					
					System.out.println("Success !! First name is correct");
					Reporter.log("Success !! First name 1 is correct"); 
				}
				else
				{
					System.out.println("Failure !! First name is incorrect");
					Reporter.log("Failure !! First name is incorrect"); 
					AssertFailedCount++;
				}
				
				if(SeleniumFunc.GetAttributeValue("id", "StudentModel_last_name", "value").equals(lastname))
				{
					
					System.out.println("Success !! Last name is correct");
					Reporter.log("Success !! Last name 1 is correct"); 
				}
				else
				{
					System.out.println("Failure !! Last name is incorrect");
					Reporter.log("Failure !! Last name is incorrect"); 
					AssertFailedCount++;
				}
				
			System.out.println("Step 4 : Make payment and revisit profile page.");
			Reporter.log("Step 4 : Make payment and revisit profile page.");
			...
			System.out.println("Step 5 : Clicking on 'Complete the Application' button" );
			Reporter.log("Step 5 : Clicking on 'Complete the Application' button");
			
				String expectedurl = SeleniumFunc.GetAttributeValue("css", "#next_text a", "href")+"/";
				SeleniumFunc.ClickOnElement("css", "#next_text a");
				String actualurl = driver.getCurrentUrl();
				
			System.out.println("Step 6 : On Application page - Stage 1 : Certification Information ,  updating User info, Contact info, navigating to Step 2 - Payment Informaiton page" );
			Reporter.log("Step 6 : On Application page - Stage 1 : Certification Information ,  updating User info, Contact info, navigating to Step 2 - Payment Informaiton page");		
			...
			System.out.println("Step 7 : On Payment Information page - Stage 2 , entering data for CC & selecting billing address=Mailing address and clicking on 'Confirm Payment Information' button" );
			Reporter.log("Step 7 : On Payment Information page - Stage 2 , entering data for CC & selecting billing address=Mailing address and clicking on 'Confirm Payment Information' button");
			...
			System.out.println("Step 8 : Verify After payment, the student cannot edit his/her name." );
			Reporter.log("Step 8: Verfy After payment, the student cannot edit his/her name.");
			
				header.Profile.click();
				Thread.sleep(5000);
				
			String actualtext = SeleniumFunc.GetElementText("css", "#main > div > section:nth-child(4) > div:nth-child(2) > div > h3");

			if(!SeleniumFunc.IsElementPresent("id", "StudentModel_first_name") && actualtext.equalsIgnoreCase("Test Ke-testing"))
			{
				System.out.println("-- Success !! After payment, the student cannot edit his/her name.");
				Reporter.log("-- Success !! After payment, the student cannot edit his/her name.");
			}
			else
			{
				System.out.println("-- Failure !! After payment, the student is able edit his/her name.");
				Reporter.log("-- Failure !! After payment, the student is able edit his/her name.");
				AssertFailedCount++;
			}
