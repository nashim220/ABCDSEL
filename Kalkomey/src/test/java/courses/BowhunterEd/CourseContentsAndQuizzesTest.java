...
public class CourseContentsAndQuizzesTest 
{
	...
	*/ 
	...
	private void Contents_ResumeLinkWorkingAsExpected() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_BowHunter + Constants.State_BowHunter);
			PageHeader header = new PageHeader(driver); Thread.sleep(2000);
			if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
			{
				header.Logout_Handgun.click();
				Thread.sleep(2000);
		...
		Reporter.log("Step 4 : Navigating to Contents page and verifying whether Start Again link is displayed and on click to it, user is navigated to correct page"); 
			...
			if(SeleniumFunc.IsElementPresent("css", "nav > ul > li.expanded > ul > li.expanded > ul > li:nth-child(2) > a"))
			{
				...
				String ExpectedText = "Page 2 of 4";
	...
	private void Contents_ContinueLeftOffButtonWorkingAsExpected() throws Exception
	{
		...
		Reporter.log("Step 5 : Navigating to Contents page and verifying whether 'Continue where you left off' button is displayed and on click to it, user is navigated to correct page"); 
			...
			if(SeleniumFunc.IsElementPresent("css", ".page.continue span"))
			{
				...
				ExpectedText = "Page 3 of 4";
				ActualText= SeleniumFunc.GetElementText("css", "#course_controls > li:nth-child(2) > ul > li:nth-child(3) > b");
				//ActualText= SeleniumFunc.GetElementText("css", ".page.continue span");
				System.out.println("Actual Text : "+ActualText +" Expected text is :"+ExpectedText);
				
				if(ActualText.equals(ExpectedText))
				{
					System.out.println("Success !! User is navigated to correct page Actual Text : "+ActualText +" Expected text is :"+ExpectedText);
					Reporter.log("Success !! User is navigated to correct page Actual Text : "+ActualText +" Expected text is :"+ExpectedText);

				}
				else
				{
					System.out.println("Failure !! User is navigated to incorrect page Actual Text : "+ActualText +" Expected text is :"+ExpectedText);
					Reporter.log("Failure !! User is navigated to incorrect page Actual Text : "+ActualText +" Expected text is :"+ExpectedText);
					AssertFailedCount++;
				}
	...
	*/ 
	...
	private void Contents_VerifyUnitTopicPageNumber() throws Exception
	{
		...
		Reporter.log("Step 3 : On Contnets page, verify that Unit/Topic/Page number correctly displayed on contents page"); 
			...
			for (int i=1;i<3;i++)
			{
				String ExpectedText = "Unit 1 of 8";
	...
	*/ 
	...
	Reporter.log("Step 6 : Click on 'See a Critique of Your Quiz Results' button");
		...
		String tempurl = "https://qa1.bowhunter-ed.com/exam/critique/700022816/";
	...
	Reporter.log("Step 8 : Clicking 'Back to the Quiz Results' button");
		...
		String tempurl2="https://qa1.bowhunter-ed.com/exam/quiz/700022816/?override_reset=1";
		SeleniumFunc.ClickOnElement("css", "#prev_text a");
		Thread.sleep(5000);
		System.out.println(driver.getCurrentUrl());
	...
	*/ 
	...
	private void Contents_ContentVerification() throws Exception
	{
		...
		Reporter.log("Step 2 : On Contents page, verifying Page Header, Introduction Text, Units, Exams related text"); 
			...
			//Verifying Page header
				...
				String expected = "Alaska Bowhunter Ed Course";
			...
			//Verifying Exam text	
				...
				expected = "Field Day Qualifier Exam";
	...
	private void Contents_TimedCourseVerification() throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL_BowHunter +Constants.State_BowHunter);
		Reporter.log("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL_BowHunter +Constants.State_BowHunter); 
		...
		Reporter.log("Step 5 : Navigating back to Contents page and Expanding Unit 1, Expanding Topic 3 , clicking on Page 1 link"); 
			...
			try
			{
			content.Untimed_GetUnitHrefLink(1, 2, 1);
			Thread.sleep(5000);

			content.Untimed_ClickOnUnitTopicPageLink(1,2,1);
			Thread.sleep(5000);
	 ...
	 * */ 
	@Test
	private void Video_Transcript_BW() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 19 : Verify that video transcript is displayed along with video"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 19 : Verify that video transcript is displayed along with video"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 3 : Clicking on 'Complete the Application' button");
			...
			Reporter.log("Step 4 : Go to Video Transcript page" );
				...
				SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_BowHunter + Constants.State_BowHunter + "/course_content/course/301001/section/700096243");
