...
public class StudyGuideTest 
{
	 ...
	 * */ 
	@Test(dataProvider="StudyGuide_bowhunter",dataProviderClass=utility.TestNG.class)
	private void Navigate_To_StudyGuide_Page(String state) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
		{
			...
			Thread.sleep(4000);
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_BowHunter + state);
			Thread.sleep(4000);
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL_BowHunter.substring(5) + state + "/studyGuide/";
	 ...
	 * */ 
	@Test
	private void StudyGuide_Content_Verification() throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 3 : Verifying contents on 'Study Guide' page");
			...
			//Verifying about sections i.e. title text, body, Learn More button, Register for the Course button
				...
				String expectedtext1 = "You are looking at a preview of";
				String expectedtext2 = "in the timed Alaska Bowhunter Ed Course. Feel free to look around, but";
				String expectedtext3 = "need to register to begin progress toward getting your Alaska Bowhunter Education Certificate.";
				//expectedtext = "You are looking at a preview of what’s in the timed Alaska Bowhunter Ed Course. Feel free to look around, but you’ll need to register to begin progress toward getting your Alaska Bowhunter Education Certificate.";
				actualtext = studyguide.About_PageHeaderText.getText().trim();
				
				if(actualtext.startsWith(expectedtext1) && actualtext.contains(expectedtext2) && actualtext.endsWith(expectedtext3))
				{
					System.out.println(" -- Success !! About section has correct text i.e. " + actualtext);
					Reporter.log("-- Success !! About section has correct text i.e. " + actualtext);
				}
				else
				{
					System.out.println(" -- Failure !! About section has incorrect text i.e. " + actualtext);
					Reporter.log("-- Failure !! About section has correct text i.e. " + actualtext);
					AssertFailedCount++;
				}
		 ...
		 // Verifying content section title
				expectedtext = "Study Guide for Alaska Bowhunter Education Certificate";
		...
		Reporter.log("Step 4 : Clicking on 'Learn More' button");
			...
			expectedtext = Constants.ApplicationURL_BowHunter.substring(5) + Constants.State_BowHunter;
			actualtext = driver.getCurrentUrl();
		...
		Reporter.log("Step 5 : Clicking on 'Register for the Course' button");
			...
			Thread.sleep(4000);
			expectedtext = Constants.ApplicationURL_BowHunter.substring(5) + "/register/create";
			actualtext = driver.getCurrentUrl();
	 ...
	 * */ 
	@Test
	private void StudyGuide_Topic_Sequence() throws Exception
	{
		System.out.println("====" + "\n" +
	   ...
	   System.out.println("Step 5 : Accessing page for : Unit 6, Topic 5, Sub Topic 2 ");
	   Reporter.log("Step 5 : Accessing page for : Unit 6, Topic 5, Sub Topic 2");

			expectedtext = studyguide.Get_href_for_Unit_Topic_SubTopic(6, 5, 2)+"/";
			Thread.sleep(4000);
	
			studyguide.ClickOn_Unit_Topic_SubTopic(6, 5, 2);
