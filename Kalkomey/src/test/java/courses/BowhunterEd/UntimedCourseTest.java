...
public class UntimedCourseTest 
{
	...
	*/ 
	...
	private void Untimed_TimerNotDisplayed() throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to untimed course State page : " + Constants.ApplicationURL_BowHunter + Constants.State_BowHunter_UnTimed);
		Reporter.log("Step 1 : Navigate to untimed course State page : " + Constants.ApplicationURL_BowHunter + Constants.State_BowHunter_UnTimed); 
		
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_BowHunter + Constants.State_BowHunter_UnTimed);
		...
		Reporter.log("Step 2 : Register as a New user"); 
			...
			String username="southdakota"+ JH.GenerateRandomNumber();
	...
	private void Untimed_AtteptFinalExam() throws Exception
	{
		...
		Reporter.log("Step 3 : Attempting all quizes one by one and verifying whether user is allowed to attemp final exam or not"); 		
			...
			for(int i=1;i<9;i++)
			{
				...
				String expected = "Please complete all the unit quizzes before attempting the 'Online Certification Exam'";
			...
			String expected = "Take the Online Certification Exam";
	...
	*/ 
	...
	private void Untimed_FinalExam_UIVerification() throws Exception
	{
		...
		System.out.println("Step 3 : Clicking on 'Take the Online Certification Exam' button");
		Reporter.log("Step 3 : Clicking on 'Take the Online Certification Exam' button"); 
		...
		Reporter.log("Step 4 : Verifying UI elements on Final Exam page");
			...
			if(practiceexam.PageTitle.getText().trim().equals("Online Certification Exam"))
			{
				System.out.println("-- Page header is correct i.e. Online Certification Exam"  );
				Reporter.log("-- Page header is correct i.e. Online Certification Exam");
			}
			else
			{
			...
			//verifying rules
			String expectedtext = "Before taking the Online Certification Exam, make sure you have reviewed all of the course material." + "\n" + 
			...
			//verifying 'Begin the Online Certification Exam' button
			if(finalexam.FinalExam.getText().trim().contains("Begin the Online Certification Exam"))
			{
				System.out.println("-- 'Begin the Online Certification Exam' button is present"  );
				Reporter.log("-- 'Begin the Online Certification Exam' button is present");
			}
			else
			{
				System.out.println("-- 'Begin the Online Certification Exam' button is not present"  );
				Reporter.log("-- 'Begin the Online Certification Exam' button is not present ");
				AssertFailedCount++;
			}
	...
	/* Test 5: 
	 * Untimed Course - Final Exam :  Verify all buttons works as expected i.e. 'Previous', 'Take the Online Certification Exam' 
	*/ 
	@Test()
	private void Untimed_FinalExam_UI_Buttons() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 5 : Untimed Course - Final Exam :  Verify all buttons works as expected i.e. 'Previous', 'Take the Online Certification Exam' "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 5 : Untimed Course - Final Exam :  Verify all buttons works as expected i.e. 'Previous', 'Take the Online Certification Exam' "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 6 : On Final Exam page, clicking 'Begin the Online Exam' button");
			...
			String expectedtext = "Online Certification Exam / Question 1 of 60";
	...
	*/ 
	...
	private void Untimed_FinalExam_Fail() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying Final Exam result page when result = Fail");
			...
			//verifying header
			expectedtext = "Online Certification Exam";
			...
			expectedtext = "See a Critique of Your Online Certification Exam Results";
	...
	private void Untimed_FinalExam_Pass() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Final Exam result page when result = Pass");
			...
			//verifying header
			String expectedtext = "Online Certification Exam";
			...
			expectedtext = "Next, get your Online Course Completion Certificate";
			actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] h2");
