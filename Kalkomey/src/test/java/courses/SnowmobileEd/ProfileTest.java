...
public class ProfileTest 
{
	...
	*/ 
	...
	private void Profile_UIElementVerification() throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Snowmobile);
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ProfilePage_Snowmobile); 
		...
		System.out.println("Step 4 : Verifying presence sections : 'Your Snowmobile Ed Account' and 'Account Information' ");
		Reporter.log("Step 4 : Verifying presence sections : 'Your Snowmobile Ed Account' and 'Account Information' "); 	
			
			if(SeleniumFunc.GetElementText("css", "div#main section:nth-of-type(1) h2").equals("Your Snowmobile Ed Account"))
			{
				
				System.out.println("Success !! 'Your Snowmobile Ed Account' section is present");
				Reporter.log("Success !! 'Your Snowmobile Ed Account' section is present"); 
			}
			else
			{
				System.out.println("Failure !! 'Your Snowmobile Ed Account' section is NOT present");
				Reporter.log("Failure !! 'Your Snowmobile Ed Account' section is NOT present"); 
				AssertFailedCount++;
			}
	...
	/* Test 2: 
	 * Verify that 'Your Snowmobile Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address
	*/ 
	@Test
	private void Profile_YourBoaEdAccountSection() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Verify that 'Your Snowmobile Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Verify that 'Your Snowmobile Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Verifying 'Your Snowmobile Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address");
		Reporter.log("Step 3 : Verifying 'Your Snowmobile Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"); 
	...
	*/ 
	...
	/* Test 4: 
	 * Verify user edit profile information successfully - editing Gender, Student ethnicity, Email Address, Mailing Address fields
	*/ 
	@Test
	private void Profile_Edit1() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 4 : Verify user edit profile information successfully - editing Gender, Student ethnicity, Email Address, Mailing Address fields"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 4 : Verify user edit profile information successfully - editing Gender, Student ethnicity, Email Address, Mailing Address fields"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Editing all fields (i.e. Gender, Student ethnicity, Email Address, Mailing Address) and clicking on 'Update Profile' button");
		Reporter.log("Step 3 : Editing all fields (i.e. Gender, Student ethnicity, Email Address, Mailing Address) and clicking on 'Update Profile' button");
			...
			profile.SelectEthnicity(ethnicity);
		...
		Reporter.log("Step 5 : Navigating to Profile page and verifying edited details");
			...
			//Verifying Ethnicity
			if(SeleniumFunc.GetSelectedValueFromDropdownList("id", "race").equals(ethnicity))
			{
				
				System.out.println("Success !! Ethnicity is correct");
				Reporter.log("Success !! Ethnicity is correct"); 
			}
			else
			{
				System.out.println("Failure !! Ethnicity is incorrect");
				Reporter.log("Failure !! Ethnicity is incorrect"); 
				AssertFailedCount++;
			}
	...
	*/ 
	...
	private void Profile_HideUnhidePhysicalAddress() throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Snowmobile);
		Reporter.log("Step 2 : Navigate to Profile page  : " + Constants.ProfilePage_Snowmobile); 
	...
	*/ 
	...
	private void Profile_CountryDropdown_Values() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			String username= "profileSnowmobile" + JH.GenerateRandomNumber();
			System.out.println(username);
			String emailprefix = "profileSnowmobile" + JH.GenerateRandomNumber();
			String emailaddress= emailprefix + "@mailinator.com";
			String password = "clarion@123";
		...
		Reporter.log("Step 3 : Verifying that all countries should be displayed under counrty dropdown"); 
			...
			String[][] countries_temp = Read1.GetTableArray(Constants.TestDataFileLocation, "SnowmobileEd","Countries");
			Thread.sleep(4000);
