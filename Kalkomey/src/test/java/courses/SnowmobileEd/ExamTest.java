	...
	*/ 
	...
	private void FinalExam_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying UI elements on Final Exam page");
			...
			//verifying rules
			String expectedtext = "Before taking the Final Exam, make sure you have reviewed all of the course material." + "\n" + 
	...
	private void FinalExam_QuestionPage_UIVerification_1() throws Exception
	{
		...
		Reporter.log("Step 5 : On Final exam page , Clicking on Next button without selecting any answer");
			...
			if(SeleniumFunc.IsElementPresent("css", "div [class='modal hide fade in']"))
			{
				...
				String ActualText = SeleniumFunc.GetElementText("css", "div.modal-header h2").trim() + "\n" +
						SeleniumFunc.GetElementText("css", "div.modal-body p").trim() ;
	...
	private void FinalExam_ResultsFail() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.AdminURL);
			keadmin.StudentSearchAndActivity(username, "Snowmobile", "Fast Forward Fail");
	...
	private void FinalExam_ResultsPass() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Pass' and navigating back to Exam result page"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.AdminURL);
			keadmin.StudentSearchAndActivity(username, "Snowmobile", "Fast Forward Pass");
		...
		Reporter.log("Step 4 : Verifying Final Exam result page when result = Pass");
			...
			expectedtext = "Next, get your Temporary Snowmobile Education Certificate";
			actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] h2");
	...
	private void FinalExam_MaxAttemptAL() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile + "/illinois");
			Thread.sleep(4000);
			if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
			{
				header.Logout_Handgun.click();
			...
			for (int i=1;i<3;i++)
			{
				...
				Reporter.log("Step 3 : Verifying Final Exam result page when result = Fail");
					...
					else
					{
					 ...
					 String expectedS = "You may re-study the course material by clicking";
					 String expectedE = "in the site navigation at the top of the page.";
					// expectedtext = "You may re-study the course material by clicking  \"“Contents”\" in the site navigation at the top of the page.";
					//expectedtext = "You may re-study the course material by clicking “Contents” in the site navigation at the top of the page.";
					...
					if(actualtext.startsWith(expectedS) && actualtext.endsWith(expectedE))
					//if(actualtext.contains(expectedtext))
					{
