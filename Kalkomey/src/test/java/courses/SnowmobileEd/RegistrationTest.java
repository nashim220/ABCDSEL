...
public class RegistrationTest 
{
	...
	*/ 
	@Test(dataProvider="Registration_snowmobile",dataProviderClass=utility.TestNG.class)
								...
								String repeatemailaddress) throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to Applicaiton URL : " + Constants.ApplicationURL_Snowmobile);
		Reporter.log("Step 1 : Navigate Applicaiton URL : " + Constants.ApplicationURL_Snowmobile); 
			
			
	
			
		System.out.println("Step 2 : Navigate to Registration page : " + Constants.ApplicationURL_Snowmobile + Constants.State_Snowmobile);
		Reporter.log("Step 2 : Navigate to Registration page : " + Constants.ApplicationURL_Snowmobile + Constants.State_Snowmobile); 
...
@Test
	...
	*/ 
	...
	/* Test 15: 
	 * Verify title of page i.e. Register for the Snowmobile {State} Course
	*/ 
	@Test
	private void Registration_VerifyTitle() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 15 : Verify title of page i.e. Register for the Snowmobile {State} Course"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 15 : Verify title of page i.e. Register for the Snowmobile {State} Course"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Verifying Page Title i.e. Register for the Snowmobile {State} Course ");
		Reporter.log("Step 3 : Verifying Page Title i.e. Register for the Snowmobile {State} Course "); 
			...
			String ExpectedValidationMessage="Register for the " + Constants.State_Snowmobile.substring(1, Constants.State_Snowmobile.length()) + " Snowmobile Ed Course" + "\n" +
	...
	*/ 
	...
	private void Registration_VerifyAccountCreationEmail() throws Exception
	{
		...
		Reporter.log("Step 4 : Navigating to Email Box and verifying whether email is received with correct details or not"); 
			...
			String ExpectedMessageTitle="Welcome to the " +Constants.State_Snowmobile.substring(1, Constants.State_Snowmobile.length()) + " Snowmobile Ed Course"; 
			...
			try
			{
				...
				String ExpectedMessageBody =
						"Hi test," + "\n" + "\n" +
						"Thank you for registering for the " + Constants.State_Snowmobile.substring(1, Constants.State_Snowmobile.length())+ " Snowmobile Ed Course." + "\n" + "\n" +
						...
						Constants.ApplicationURL_Snowmobile + "/site/login" + "\n" + "\n" + "\n" +
	...
	*/ 
	@Test(dataProvider="Registration_ResidencyRequirement_snowmobile",dataProviderClass=utility.TestNG.class)
	private void Registration_ResidencyRequirement(String State_Snowmobile) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		System.out.println("Step 2 : Navigate to Registration page : " + Constants.ApplicationURL_Snowmobile + State_Snowmobile);
		Reporter.log("Step 2 : Navigate to Registration page : " + Constants.ApplicationURL_Snowmobile + State_Snowmobile); 
		
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile + State_Snowmobile);
			PageHeader header = new PageHeader(driver); Thread.sleep(4000);
			if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
			{
				header.Logout_Handgun.click();
	...
	*/ 
	@Test(dataProvider="Registration_MimAgeValidation_snowmobile",dataProviderClass=utility.TestNG.class)
							...
							) throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Registration page : " + Constants.ApplicationURL_Snowmobile + state);
		Reporter.log("Step 2 : Navigate to Registration page : " + Constants.ApplicationURL_Snowmobile + state); 
		
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile + state);
			PageHeader header = new PageHeader(driver); Thread.sleep(4000);
			if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
			{
				header.Logout_Handgun.click();
