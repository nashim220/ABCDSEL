...
public class CertificateTest 
{
	...
	private void Certificate_Email() throws Exception
	{
		...
		Reporter.log("Step 7 : On 'View Receipt' page, click on 'Email' button");
			...
			expectedtext = "Your Temporary Snowmobile Education Certificate has been sent to your e-mail address " + emailaddress + ".";
		...
		Reporter.log("Step 8 : Verifying whether Email is received by user or not");
			...
			if(ActualMessageTitle.equalsIgnoreCase(ExpectedMessageTitle.trim()))
			{
			...
			try
			{
				...
				String ExpectedMessageBody =
						"Hi test," + "\n" + "\n" +
						"Congratulations on passing the " + Constants.State_Snowmobile.substring(1, Constants.State_Snowmobile.length()) + " Snowmobile Ed Course. Your Temporary Snowmobile Education Certificate is attached.." + "\n" + "\n" + 
