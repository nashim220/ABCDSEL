...
public class PaymentTest 
{
	...
	private void PaymentStage1_UI_Verification() throws Exception
	{
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information , verfiying UI/Text information");
			...
			String expectedtext = "Your Application for the Snowmobile Education Certificate";
	...
	private void PaymentStage1_EditUpdateFields() throws Exception
	{
		...
		Reporter.log("Step 2: Updating user profile"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ProfilePage_Snowmobile);
			Thread.sleep(4000);
	...
	*/		
	...
	private void PaymentStage1_NavigateToNextStage() throws Exception
	{
		...
		Reporter.log("Step 6 : On Confirm Information model , clicking on 'Continue Payment Information' button");
			...
			expectedurl = Constants.ApplicationURL_Snowmobile + "/register/payment/" ;
	...
	private void PaymentStage2_UI_Verification() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , , verfiying UI/Text information");
			...
			String expectedtext = "Your Payment for the Snowmobile Education Certificate";
			...
			expectedtext = "Indiana Snowmobile Ed Course Fee";
	...
	private void PaymentStage2_ConfirmationPopUpDatails() throws Exception
	{
		...
		Reporter.log("Step 6 : Clicking on 'Payment Cerification Information' button and verifying details on 'Confirm Your Payment Information' model");
			...
			expectedtext = "Acceptance of Terms" + "\n" + 
							"I understand that I will be charged the total listed above and that there are no refunds or cancellations. I have agreed to these terms.";
	...
	private void PaymentStage2_PayWithCoupon() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , entering valid Coupon code and clicking on 'Apply Code' button");
			...
			expectedtext = Constants.ApplicationURL_Snowmobile + "/register/paymentconfirm/payment/";
	...
	private void PaymentStage2_PayWithCreditCard() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , entering data for CC & selecting billing address=Mailing address and clicking on 'Confirm Payment Information' button");
			...
			String expectedtext = Constants.ApplicationURL_Snowmobile + "/register/paymentconfirm/payment/";
	...
	private void PaymentStage2_PaymentConfirmationEmail() throws Exception
	{
		...
		Reporter.log("Step 6 : Navigating to Email Box and verifying whether payment confirmation email is received with correct details or not"); 
			...
			String ExpectedMessageTitle=Constants.State_Snowmobile.substring(1, Constants.State_Snowmobile.length()) + " Snowmobile Ed" + " Course - Customer Receipt"; 
	...
	private void PaymentStage3_ViewReceiptPageDetails() throws Exception
	{
		...
		Reporter.log("Step 6 : Verifying details on 'View Receipt' page"); 
			...
			// Verifying presence of 'Get Your Temporary Snowmobile Education Certificate' button
			
					expectedtext = "Get Your Temporary Snowmobile Education Certificate";
					actualtext = receipt.GetYourProofofHomeStudyVoucher.getText().trim();
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! 'Get Your Temporary Snowmobile Education Certificate' button  is present i.e. " + actualtext );
						Reporter.log("-- Success !! 'Get Your Temporary Snowmobile Education Certificate' button  is present i.e. " + actualtext );
						
					}
					else
					{
						System.out.println("-- Failure !! 'Get Your Temporary Snowmobile Education Certificate' button  is NOT present. Expected is : " + expectedtext + " , Actual is : " + actualtext );
						Reporter.log("-- Failure !! 'Get Your Temporary Snowmobile Education Certificate' button  is NOT present. " + expectedtext + " , Actual is : " + actualtext);
						AssertFailedCount++;
					}
	...
	/* Test 19: 
	 * View Receipt - Stage 3 :  Verify on click to 'Snowmobile Education Certificate' button , user is navigated to Course Complete page
	 * */ 
	@Test
	private void PaymentStage3_NavigateToCourseCompeletePage() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 19 : View Receipt - Stage 3 :  Verify on click to 'Get Your Temporary Snowmobile Education Certificate' button , user is navigated to Course Complete page"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 19 : View Receipt - Stage 3 :  Verify on click to 'Get Your Temporary Snowmobile Education Certificate' button , user is navigated to Course Complete page"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 6 : On 'View Receipt' page, clicking on 'Get Your Temporary Snowmobile Education Certificate ' button");
		Reporter.log("Step 6 : On 'View Receipt' page, clicking on 'Get Your Temporary Snowmobile Education Certificate' button"); 
			
			receipt.GetYourProofofHomeStudyVoucher.click();
			Thread.sleep(4000);
			
			//Verifying Url
			String expectedtext = Constants.ApplicationURL_Snowmobile + "/course/course_complete";
			String actualtext = driver.getCurrentUrl();
			...
			if(actualtext.contains(expectedtext))
			{
				...
				expectedtext = "You Have Completed the Indiana Snowmobile Ed Course";
	...
	private void PaymentStage3_VerifyCourseCompeletePage() throws Exception
	{
		...
		Reporter.log("Step 7 : On 'View Receipt' page, verifying details");
			...
			//Verifying congratulation message
				...
				expectedtext = "Congratulations, you have successfully completed the Indiana Snowmobile Ed Course.";
			...
			//Verifying presence of 'Download' button
				...
				expectedtext = "Download the Indiana Temporary Snowmobile Education Certificate";
			...
			//Verifying presence of 'Email' button
				...
				expectedtext = "E-mail the Indiana Temporary Snowmobile Education Certificate";
	 ...
	 * */ 
	@Test
	private void BillingInfoPersistAfterCoupon_Snow() throws Exception
	{
		System.out.println("====" + "\n" +
