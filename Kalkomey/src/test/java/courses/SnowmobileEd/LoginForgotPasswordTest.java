...
public class LoginForgotPasswordTest 
{
	...
	*/ 
	...
	private void Login_UIElementVerification() throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to Login page : " + Constants.ApplicationURL_Snowmobile + "/site/login");
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ApplicationURL_Snowmobile + "/site/login"); 
	...
	*/ 
	@Test(dataProvider="Login_RestrictedPages_snowmobile",dataProviderClass=utility.TestNG.class)
	private void Login_RestrictedPages(String restricted_pages) throws Exception
	{
		...
		Reporter.log("Step 1 : Trying to access Restricted Pages and verifying whether user is navigated to Home page or not"); 
			...
			restricted_pages = Constants.ApplicationURL_Snowmobile + restricted_pages;
			...
			if(SeleniumFunc.IsElementPresent(header.Logout_Handgun))
			{
				...
				if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Snowmobile.subSequence(5,Constants.ApplicationURL_Snowmobile.length())))
				{
	...
	*/ 
	...
	private void Login_Logout() throws Exception
	{
		...
		Reporter.log("Step 2: Logging out of application"); 
			...
			//SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile+ "/site/logout'");
		...
		Reporter.log("Step 4 : Verifying whether user is logged out successfully or not"); 
				...
				if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Snowmobile.subSequence(5,Constants.ApplicationURL_Snowmobile.length())+ "/site/logout"))
				{
...
/*	 Test 7: 
	...
	private void Login_PasswordResetEmail() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile);
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile + Constants.State_Snowmobile);
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Snowmobile + "/register/create");
		...
		Reporter.log("Step 5 : Verifying whether Password Reset Email sent to user or not"); 
			...
			String ExpectedMessageBody =
					"Dear test" + "\n" + 
					"This e-mail contains instructions on resetting your password for the online course at Snowmobile Ed.com."  + "\n" +
					...
					"Thanks and safe snowmobiling!" + "\n" +

					"Snowmobile Ed Support";
	...
	*/ 
	...
	private void Login_PasswordResetEmail() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether Password Reset Email sent to user or not"); 
			...
			String ExpectedMessageBody =
					"Dear test" + "\n" + 
					"The following instructions will help you reset your password for your online course at snowmobile-ed.com."  + "\n" +
...
/*	 Test 8: 
	...
	private void Login_PasswordReset() throws Exception
	{
		...
		Reporter.log("Step 7 : Verifying user is navigated to '/register/edit' page and proper confirmation message is dispalyed on that page");
			...
			if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Snowmobile.subSequence(5,Constants.ApplicationURL_Snowmobile.length())+ "/register/edit"))
			{
	...
	*/ 
	...
	private void Login_PasswordReset() throws Exception
	{
		...
		Reporter.log("Step 5 : Navigating to Email box and clicking on 'reset your password' link from Password Reset Email"); 
			...
			//Clicking on  'reset your password' link
			SeleniumFunc.ClickOnElement("css", "tbody>tr>td>a");
		...
		System.out.println("Step 6 : Verify message on Reset Password screen");
		Reporter.log("Step 6 : Verify message on Reset Password screen");
						
			String ExpectedText =  resetpassword.Info_ResetPassword.getText().trim();
			String ActualText = "You are updating the password for user: " + username;
					
			if(ActualText.equals(ExpectedText))
			{
				System.out.println("Success !! Correct message for Reset Password is displayed" + ExpectedText);
				Reporter.log("Success !! Correct message for Reset Password is displayed" + ExpectedText); 
			}
			else
			{
				System.out.println("Failure !!  Incorrect message for Reset Password " + ExpectedText);
				Reporter.log("Failure !!  Incorrect message for Reset Password " + ExpectedText); 
				AssertFailedCount++;
			}			
						
		System.out.println("Step 7 : Entering values in New Password / Re-enter New Password fields");
		Reporter.log("Step 7 : Entering values in New Password / Re-enter New Password fields");
		...
		System.out.println("Step 8 : Verifying user is navigated to '/register/edit' page and proper confirmation message is dispalyed on that page");
		Reporter.log("Step 8 : Verifying user is navigated to '/register/edit' page and proper confirmation message is dispalyed on that page");
			...
			if(ActualValidationMessage.contains(ExpectedValidationMessage))
			{
				System.out.println("Success !! Correct confirmation messages are displayed. i.e." + ExpectedValidationMessage);
				Reporter.log("Success !! Correct confirmation messages are displayed. i.e." + ExpectedValidationMessage); 
			}
			else
			{
				System.out.println("Failure !!  Incorrect confirmation messages are displayed " + "\n" + "Expected confirmation messages : "  
		...
		System.out.println("Step 9:  Trying login with new password and verifying whether user is logged in or not");
		Reporter.log("Step 9:  Trying login with new password and verifying whether user is logged in or not");
		...
		System.out.println("Step 10 : Verifying whether user is logged successfully or not");
		Reporter.log("Step 10 : Verifying whether user is logged successfully or not"); 
...
*/	
	...
	/* Test 9: 
	 * Check for validation on reset password page  A) keep Email Address blank 
	*/ 
	@Test
	private void Login_ForgotPasswordValidationCheck1() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 9 : Check for validation on reset password page  A) keep Email Address blank "  + "\n" + "====");
		Reporter.log("====" + "\n" +
				"Test 9 : Check for validation on reset password page  A) keep Email Address blank "  + "\n" + "====");
		...
		Reporter.log("Step 4 : Verifying whether validation messages are displayed "); 
			...
			if(ActualValidationMessage.contains(ExpectedValidationMessage))
			{
				System.out.println("Success !! Correct validation messages are displayed. i.e." +ExpectedValidationMessage);
				Reporter.log("Success !! Correct validation messages are displayed. i.e." +ExpectedValidationMessage); 
			}
			else
			{
				System.out.println("Failure !!  Incorrect validation messages are displayed " + "\n" + "Expected Validation messages : "  
	...
	*/ 
	...
	{
		System.out.println("====" + "\n" +
					"Test 10 : Check for validation on reset password page  A) Enter incorrect Email Address"  + "\n" + "====");
		Reporter.log("====" + "\n" +
				"Test 10 : Check for validation on reset password page  A) Enter incorrect Email Address"  + "\n" + "====");
	...
	*/ 
	...
	private void Login_SessionTimeout() throws Exception
	{
		...
		Reporter.log("Step 1 : Do not do any activity for 25 mins and refreshing page after 25 mins"); 
			...
			String expectedurl = Constants.ApplicationURL_Snowmobile + "/site/login/";
	...
	*/ 
	...
	private void Error_Dismiss() throws Exception
	{
		...
		Reporter.log("Step 4 : Now close validation message box with 'x' icon"); 
			...
			if(SeleniumFunc.IsElementPresent("css", "#loginForm div[class='alert alert-block alert-error'] p"))
			{
