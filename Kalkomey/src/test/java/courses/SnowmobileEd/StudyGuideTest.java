...
public class StudyGuideTest 
{
	 ...
	 * */ 
	@Test(dataProvider="StudyGuide_snowmobile",dataProviderClass=utility.TestNG.class)
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL_Snowmobile.substring(5) + state + "/studyGuide/";
	...
	private void StudyGuide_Content_Verification() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying contents on 'Study Guide' page");
			...
			//Verifying about sections i.e. title text, body, Learn More button, Register for the Course button
				...
				expectedtext = "You are looking at a preview of what’s in the timed Indiana Snowmobile Ed Course. Feel free to look around, but you’ll need to register to begin progress toward getting your Snowmobile Education Certificate.";
		 ...
		 // Verifying content section title
				expectedtext = "Study Guide for Snowmobile Education Certificate";
		...
		Reporter.log("Step 4 : Clicking on 'Learn More' button");
			...
			expectedtext = Constants.ApplicationURL_Snowmobile.substring(5) + Constants.State_Snowmobile;
			actualtext = driver.getCurrentUrl();
		...
		Reporter.log("Step 5 : Clicking on 'Register for the Course' button");
			...
			Thread.sleep(5000);
			expectedtext = Constants.ApplicationURL_Snowmobile.substring(5) + "/register/create";
			actualtext = driver.getCurrentUrl();
