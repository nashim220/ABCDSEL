	...
	*/ 
	...
	private void Dashboard_CompleteApplication() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying whether user is asked to 'Complete Registration and Payment' on login ");
			...
			String expectedtext = "Congratulations, you have successfully completed the Indiana Snowmobile Ed Course.";
			...
			expectedtext = "In order to receive your Temporary Snowmobile Education Certificate you must pay for your registration.";
	...
	private void Dashboard_VerifyAfterPayment() throws Exception
	{
		...
		Reporter.log("Step 6 : Logout and login again , verifying dashboard"); 
			...
			//Verifying congratulation message
				...
				expectedtext = "Congratulations, you have successfully completed the Indiana Snowmobile Ed Course. You may now download your Indiana Temporary Snowmobile Education Certificate or have it sent to your registered e-mail address.";
