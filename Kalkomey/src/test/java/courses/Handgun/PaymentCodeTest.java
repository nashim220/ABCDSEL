...
public class PaymentCodeTest 
{
	...
	private void PaymentCode_Type_Percentage() throws Exception
	{
		...
		System.out.println("Step 2 : On Payment Information page - Stage 2 , applying coupon code" );
		Reporter.log("Step 2 : On Payment Information page - Stage 2 , applying coupon code");
		...
		System.out.println("Step 3 : Verifying Total Amount on 'View Receipt' page");
		Reporter.log("Step 3 : Verifying Total Amount on 'View Receipt' page"); 
		
			//Total Fee
			expectedtext = "Total Amount: $9.75";
	...
	private void PaymentCode_Type_Pass() throws Exception
	{
		...
		System.out.println("Step 4 : Navigate to KE Admin > View Payment Code page and verify 'Uses'");
		Reporter.log("Step 4 : Navigate to KE Admin > View Payment Code page and verify 'Uses'"); 
