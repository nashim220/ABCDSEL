...
public class LoginForgotPasswordTest 
{
	...
	*/ 
	...
	private void Login_UIElementVerification() throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to Login page : " + Constants.ApplicationURL_Handgun + "/site/login");
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ApplicationURL_Handgun + "/site/login"); 
	...
	*/ 
	@Test(dataProvider="Login_RestrictedPages_hunter",dataProviderClass=utility.TestNG.class)
	private void Login_RestrictedPages(String restricted_pages) throws Exception
	{
		...
		Reporter.log("Step 1 : Trying to access Restricted Pages and verifying whether user is navigated to Home page or not"); 
			...
			restricted_pages = Constants.ApplicationURL_Handgun + restricted_pages;
			SeleniumFunc.ToGoToUrl(restricted_pages);
			
			Thread.sleep(4000);

				if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Handgun.subSequence(5,Constants.ApplicationURL_Handgun.length())))
				{
	...
	*/ 
	...
	private void Login_Logout() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying whether user is logged out successfully or not"); 
			...
			if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Handgun.subSequence(5,Constants.ApplicationURL_Handgun.length())+ "/site/logout"))
			{
	...
	private void Login_PasswordResetEmail() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether Password Reset Email sent to user or not"); 
			...
			String ExpectedMessageBody =
					"Dear test" + "\n" + 
					"This e-mail contains instructions on resetting your password for the online course at Handgun Safety Course.com."  + "\n" +
	...
	*/ 
	...
	private void Login_PasswordResetEmail() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether Password Reset Email sent to user or not"); 
			...
			//String Username = SeleniumFunc.GetElementText("css", ".mailview>ul>li");
			
			String ExpectedMessageBody =
					"Dear test" + "\n" + 
					"The following instructions will help you reset your password for your online course at handgunsafetycourse.com."  + "\n" +
...
/*	
	...
	private void Login_PasswordReset() throws Exception
	{
		...
		Reporter.log("Step 7 : Verifying user is navigated to '/register/edit' page and proper confirmation message is dispalyed on that page");
			...
			if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL_Handgun.subSequence(5,Constants.ApplicationURL_Handgun.length())+ "/register/edit"))
			{
...
*/	
	...
	/* Test 10: 
	 * Check for validation on reset password page  A) Enter in correct Email Address
	*/ 
	@Test
	private void Login_ForgotPasswordValidationCheck2() throws Exception
	{
	...
	*/ 
	...
	private void Login_SessionTimeout() throws Exception
	{
		...
		Reporter.log("Pre-requisite : Signing up as new User"); 
			...
			String expectedurl = Constants.ApplicationURL_Handgun + "/site/login/";
