...
public class ProfileTest 
{
	...
	*/ 
	...
	private void Profile_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			String username= "profileoffroad" + JH.GenerateRandomNumber();
			System.out.println(username);
			String emailprefix = "profileoffroad" + JH.GenerateRandomNumber();
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Handgun);
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ProfilePage_Handgun); 
			
			SeleniumFunc.ToGoToUrl(Constants.ProfilePage_Handgun);
		...
		System.out.println("Step 4 : Verifying presence sections : 'Your Handgun Safety Course Account' and 'Account Information' ");
		Reporter.log("Step 4 : Verifying presence sections : 'Your Handgun Safety Course Account' and 'Account Information' "); 	
			
			if(SeleniumFunc.GetElementText("css", "div#main section:nth-of-type(1) h2").equals("Your Handgun Safety Course Account"))
			{
				
				System.out.println("Success !! 'Your Handgun Safety Course Account' section is present");
				Reporter.log("Success !! 'Your Handgun Safety Course Account' section is present"); 
			}
			else
			{
				System.out.println("Failure !! 'Your Handgun Safety Course Account' section is NOT present");
				Reporter.log("Failure !! 'Your Handgun Safety Course Account' section is NOT present"); 
				AssertFailedCount++;
			}
	...
	/* Test 2: 
	 * Verify that 'Your Handgun Safety Course Account' section has correct details i.e. Student Name, DOB, Username, Email Address
	*/ 
	@Test
	private void Profile_YourOffroadEdAccountSection() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Verify that 'Your Handgun Safety Course Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Verify that 'Your Handgun Safety Course Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Verifying 'Your Handgun Safety Course Account' section has correct details i.e. Student Name, DOB, Username, Email Address");
		Reporter.log("Step 3 : Verifying 'Your Handgun Safety Course Account' section has correct details i.e. Student Name, DOB, Username, Email Address"); 
	...
	*/ 
	...
	private void Profile_Edit1() throws Exception
	{
		...
		Reporter.log("Step 3 : Editing all fields (i.e. Gender, , Email Address, Mailing Address) and clicking on 'Update Profile' button");
			...
			String addressline1 = "1201 W UNIVERSITY DR";
			String addressline2 = "";
			String city= "Edinburg";
			String state="Texas";
			String zip="78539";
			String country="United States of America";
			String phonenumber="234-567-1111";
	...
	*/ 
	...
	private void Profile_DefaultValues() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying default values for dropdowns fields Gender, County, State  ");
			...
			//Verifying Gender
			if(SeleniumFunc.GetSelectedValueFromDropdownList("id", "StudentModel_gender").equals("Male"))
			{
			...
			//Verifying State
			if(SeleniumFunc.GetSelectedValueFromDropdownList("id", "RegistrationModel_s_state_cd_dropdown").equals("Texas"))
			{
	...
	*/ 
	...
	private void Profile_ValidationMessageForInvalidZip() throws Exception
	{
		...
		Reporter.log("Entering invalid values to Zip field");
			...
			profile.EnterMailingAddress("1201 W UNIVERSITY DR", "", "Edinburg", "Texas", "78539111", "United States of America", "234-567-1111");
			profile.ClickOnUpdateProfileButton();
			Thread.sleep(4000);
	...
	*/ 
	...
	private void Profile_HideUnhidePhysicalAddress() throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Handgun);
		Reporter.log("Step 2 : Navigate to Profile page  : " + Constants.ProfilePage_Handgun); 
	...
	*/ 
	...
	private void Profile_CountryDropdown_Values() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying that all countries should be displayed under counrty dropdown"); 
			...
			String[][] countries_temp = Read1.GetTableArray(Constants.TestDataFileLocation, "OffroadEd","Countries");
