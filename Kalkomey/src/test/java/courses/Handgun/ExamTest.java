	...
	private void PracticeExam_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 3 : Marking all Units/Quiz as completed");
			...
			for(int i=1;i<6;i++)
			{
				...
				keadmin.StudentSearchAndActivity(username, "Handgun", "Quizzes");
		...
		/*	content.ContinueWhereYouLeftOff.click();
			Thread.sleep(5000);*/
			SeleniumFunc.ClickOnElement("xpath", "//a[contains(.,'Practice Exam')]");
			Thread.sleep(5000);
	...
	*/ 
	...
	private void PracticeExam_UI_Buttons() throws Exception
	{
		...
		Reporter.log("Step 5 : On Pracice Exam page, clicking 'Take Practical Exam' button");
			...
			String expectedtext = "Practice Exam / Question 1 of 35";
	...
	private void PracticeExam_ResumeExam() throws Exception
	{
		...
		Reporter.log("Step 5 : Log out and login again to application");
			...
			expectedtext = "Continue Practice Exam";
		...
		Reporter.log("Step 5 : On Pracice Exam page, clicking 'Continue the Practice Exam'' button");
			...
			expectedtext = "Practice Exam / Question 1 of 35";
	...
	private void FinalExam_UI_Buttons() throws Exception
	{
		...
		Reporter.log("Step 6 : On Final Exam page, clicking 'Begin Final Exam' button");
			...
			String actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			String expectedtext = "Final Exam / Question 1 of 35";
	...
	private void FinalExam_ResumeExam() throws Exception
	{
		...
		Reporter.log("Step 7 : On Final Exam page, clicking 'Continue Final Exam' button");
			...
			expectedtext = "Final Exam / Question 2 of 35";
	...
	private void FinalExam_ResultsFail() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.AdminURL);
			keadmin.StudentSearchAndActivity(username, "Handgun", "Fast Forward Fail");
	...
	private void FinalExam_ResultsPass() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Final Exam result page when result = Pass");
			...
			//Verifying presence of "Get Voucher" button
			expectedtext = "Get Voucher";
