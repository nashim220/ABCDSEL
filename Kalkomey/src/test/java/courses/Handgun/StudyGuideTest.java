...
public class StudyGuideTest 
{
	 ...
	 * */ 
	@Test
	private void Navigate_To_StudyGuide_Page() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 1 : Verify user can navigate to Study Guide page without login "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 1 : Verify user can navigate to Study Guide page without login"  + "\n" +
				 	  "====");	
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL_Handgun.substring(5) + "/handgun/studyGuide/601099/";
	...
	private void StudyGuide_Content_Verification() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying contents on 'Study Guide' page");
			...
			//Verifying about sections i.e. title text, body, Learn More button, Register for the Course button
				...
				expectedtext = "You are looking at a preview of what’s in the timed National Handgun Safety Course. Feel free to look around, but you’ll need to register to begin progress toward getting your Course Completion Certificate.";
				actualtext = studyguide.About_PageHeaderText.getText().trim();
				
				if(actualtext.startsWith("You are looking at a preview of what") && actualtext.contains("in the timed National Handgun Safety Course. Feel free to look around, but you") && actualtext.contains("need to register to begin progress toward getting your Course Completion Certificate."))
				{
				...
				else 
				{
					...
					Reporter.log("-- Failure !! About section has incorrect text i.e. " + actualtext+"\n Expected :"+expectedtext);
					AssertFailedCount++;
				}
		 ...
		 // Verifying content section title
				expectedtext = "Study Guide for Course Completion Certificate";
		...
		Reporter.log("Step 4 : Clicking on 'Learn More' button");
			...
			expectedtext = Constants.ApplicationURL_Handgun.substring(5) + "/handgun/";
			actualtext = driver.getCurrentUrl();
		...
		Reporter.log("Step 5 : Clicking on 'Register for the Course' button");
			...
			expectedtext = Constants.ApplicationURL_Handgun.substring(5) + "/register/create/";
			actualtext = driver.getCurrentUrl();
	...
	private void StudyGuide_Topic_Sequence() throws Exception
	{
	   ...
	   System.out.println("Step 5 : Accessing page for : Unit 4, Topic 5, Sub Topic 2 ");
	   Reporter.log("Step 5 : Accessing page for : Unit 4, Topic 5, Sub Topic 2");

			expectedtext = studyguide.Get_href_for_Unit_Topic_SubTopic(4, 5, 2)+"/";
			
			studyguide.ClickOn_Unit_Topic_SubTopic(4, 5, 2);
