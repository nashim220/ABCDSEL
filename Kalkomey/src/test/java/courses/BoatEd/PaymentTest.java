...
public class PaymentTest 
{
	...
	private void PaymentStage1_UI_Verification() throws Exception
	{
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information , verfiying UI/Text information");
			...
			String expectedtext = "Your Application for the Alabama Boating Course Certificate of Completion";
	...
	{
		System.out.println("====" + "\n" +
					"Test 3 : Certification Information - Stage 1 : Verify validation message for invalid values for SSN, Zip, Phone Number fields"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 3 : Certification Information - Stage 1 : Verify validation message for invalid values for SSN, Zip, Phone Number fields"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information ,  entering invalid values for SSN, Zip, Phone Number fields");
			...
			System.out.println("-- Entering invalid values to SSN field");
			Reporter.log("-- Entering invalid values to SSN field");
				
				driver.navigate().refresh();
				Thread.sleep(4000);

				cerinfo.Student_SSN.sendKeys("sdfdsf");
				cerinfo.ConfirmCertificateInformation.click();
				Thread.sleep(4000);

				ActualValidationMessage= SeleniumFunc.GetElementText("css", "#student_ssn + p").trim();
				//System.out.println(ActualValidationMessage);
				
				ExpectedValidationMessage= 
						"This Social Security number is invalid. Please use the format: 123-45-6789" ; 
				
				if(ActualValidationMessage.equals(ExpectedValidationMessage))
				{
					System.out.println("-- Success !! correct validation messages are displayed for SSN field i.e. " + ActualValidationMessage);
					Reporter.log("-- Success !! correct validation messages are displayed for SSN field i.e. " + ActualValidationMessage); 
				}
				else
				{
					System.out.println("-- Failure !!  Incorrect validation messages are displayed for SSN field" + "\n" + "Expected Validation messages : "  
										+ "\n" + ExpectedValidationMessage + "\n" + 
										 "Actual Validation messages : " + "\n" +  ActualValidationMessage);
					Reporter.log("-- Failure !!  Incorrect validation messages are displayed for SSN field" + "\n" + "Expected Validation messages : "  
							+ "\n" + ExpectedValidationMessage + "\n" + 
	...
	private void PaymentStage1_EditUpdateFields() throws Exception
	{
		...
		Reporter.log("Step 2: Updating user profile"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ProfilePage);
			Thread.sleep(4000);
		...
		Reporter.log("Step 5 : On Application page - Stage 1 : Certification Information ,  verifying User info, Contact info.");
			...
			//Verifying SSN
			expectedtext = ssn;
			actualtext = cerinfo.Student_SSN.getAttribute("value").trim();
	...
	private void PaymentStage2_UI_Verification() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , , verfiying UI/Text information");
			...
			String expectedtext = "Your Payment for the Alabama Boating Course Certificate of Completion";
			...
			expectedtext = "Alabama Boat Ed Course Fee";
	...
	private void PaymentStage2_ConfirmationPopUpDatails() throws Exception
	{
		...
		Reporter.log("Step 6 : Clicking on 'Payment Cerification Information' button and verifying details on 'Confirm Your Payment Information' model");
			...
			expectedtext = "Acceptance of Terms" + "\n" + 
							"I understand that I will be charged the course registration fee previously shown and that there are no refunds or cancellations. I have agreed to these terms.";
	...
	private void PaymentStage2_PaymentConfirmationEmail() throws Exception
	{
		...
		Reporter.log("Step 6 : Navigating to Email Box and verifying whether payment confirmation email is received with correct details or not"); 
			...
			String ExpectedMessageTitle="Boat " +Constants.State.substring(1, Constants.State.length()) + " Course - Customer Receipt"; 
	...
	private void PaymentStage3_ViewReceiptPageDetails() throws Exception
	{
		...
		Reporter.log("Step 6 : Verifying details on 'View Receipt' page"); 
			...
			// Verifying presence of 'Get Your Proof of Home Study Voucher' button
					...
					expectedtext = "Get Your Proof of Home Study Voucher";
					actualtext = receipt.GetYourProofofHomeStudyVoucher.getText().trim();
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! 'Get Your Proof of Home Study Voucher' button  is present i.e. " + actualtext );
						Reporter.log("-- Success !! 'Get Your Proof of Home Study Voucher' button  is present i.e. " + actualtext );
						
					}
					else
					{
						System.out.println("-- Failure !! 'Get Your Proof of Home Study Voucher' button  is NOT present. Expected is : " + expectedtext + " , Actual is : " + actualtext );
						Reporter.log("-- Failure !! 'Get Your Proof of Home Study Voucher' button  is NOT present. " + expectedtext + " , Actual is : " + actualtext);
						AssertFailedCount++;
					}
	...
	private void PaymentStage3_VerifyCourseCompeletePage() throws Exception
	{
		...
		Reporter.log("Step 7 : On 'View Receipt' page, verifying details");
			...
			//Verifying presence of 'After This Quiz' section
				...
				if(actualtext.contains(expectedtext))
				{
					System.out.println("-- Success !! 'After This Quiz' section is present i.e. " + actualtext );
					Reporter.log("-- Success !! 'After This Quiz' section is present i.e. " + actualtext );
					
				}
				else
				{
					System.out.println("-- Failure !! 'After This Quiz' section is NOT present . Expected is : " + expectedtext + " , Actual is : " + actualtext );
					Reporter.log("-- Failure !! 'After This Quiz' section is NOT present . " + expectedtext + " , Actual is : " + actualtext);
					AssertFailedCount++;
				}	
	 ...
	 * */ 
	@Test
	private void BillingInfoPersistAfterCoupon() throws Exception
	{
		System.out.println("====" + "\n" +
