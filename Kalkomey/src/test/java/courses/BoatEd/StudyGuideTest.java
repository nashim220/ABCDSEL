...
public class StudyGuideTest 
{
	 ...
	 * */ 
	@Test(dataProvider="StudyGuide",dataProviderClass=utility.TestNG.class)
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL.substring(5) + state + "/studyGuide/";
	...
	/* Test 2: 
	 * Verify study guide is not available for state /floridaviolator
	 * */ 
	@Test
	private void StudyGuide_Not_Exists_FV() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Verify study guide is not available for state /floridaviolator"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Verify study guide is not available for state /floridaviolator"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 2 : Verifying whether 'Study Guild' link is present on top header");
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					System.out.println("-- Failure !! 'Study Guide' link is present on page header");
					Reporter.log("-- Failure !! 'Study Guide' link is present on page header");
					AssertFailedCount++;					
				}
				else
				{
					System.out.println("-- Success !! 'Study Guide' link is NOT present on page header");
					Reporter.log("-- Success !! 'Study Guide' link is NOT present on page header");
	...
	private void StudyGuide_Content_Verification() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying contents on 'Study Guide' page");
			...
			//Verifying about sections i.e. title text, body, Learn More button, Register for the Course button
				...
				expectedtext = "You are looking at a preview of what’s in the timed Alabama Boat Ed Course. Feel free to look around, but you’ll need to register to begin progress toward getting your Alabama Boating Course Certificate of Completion.";
		 ...
		 // Verifying content section title
				expectedtext = "Study Guide for Alabama Boating Course Certificate of Completion";
		...
		Reporter.log("Step 4 : Clicking on 'Learn More' button");
			...
			expectedtext = Constants.ApplicationURL.substring(5) + Constants.State;
			actualtext = driver.getCurrentUrl();
		...
		Reporter.log("Step 5 : Clicking on 'Register for the Course' button");
			...
			expectedtext = Constants.ApplicationURL.substring(5) + "/register/create";
			actualtext = driver.getCurrentUrl();
