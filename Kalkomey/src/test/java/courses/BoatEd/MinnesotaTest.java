...
public class MinnesotaTest 
{
	...
	/* Test 1: 
	 * Minnesota  - Verify State Agency name on /minnesota page
	 * 
	 */ 
	@Test
	private void MN_VerifyAgencyName() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 1 : Minnesota - Verify State Agency name on /minnesota page"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 1 : Minnesota - Verify State Agency name on /minnesota page"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 1: Navigated to /minnesota page and verifying State Agency name");
		Reporter.log("Step 1: Navigated to /minnesota page and verifying State Agency name"); 
			
			
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL + "/minnesota");
			Thread.sleep(4000);
			...
			String expectedtext = "Minnesota Department of Natural Resources";
	...
	/* Test 2: 
	 * Minnesota  - Verify that /minnesota is a timed course & user need to move in a sequence to take a course
	 * */ 
	@Test
	private void MN_TimedCourseVerification() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Minnesota  - Verify that /minnesota is a timed course & user need to move in a sequence to take a course"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Minnesota  - Verify that /minnesota is a timed course & user need to move in a sequence to take a course"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL + "/minnesota");
		Reporter.log("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL + "/minnesota"); 
		...
		Reporter.log("Step 2 : Register as a New user"); 
			...
			String username="minnesota"+ JH.GenerateRandomNumber();
		...
		System.out.println("Step 7 : Navigating back to Contents page and Expanding Unit 1, Expanding Topic 1 , clicking on Page 2 link");
		Reporter.log("Step 7 : Navigating back to Contents page and Expanding Unit 1, Expanding Topic 1 , clicking on Page 2 link"); 
		if(SeleniumFunc.IsElementPresent(content.IntroModal))
		{
			content.IntroModal.click();
			Thread.sleep(4000);
	...
	/* Test 3: 
	 * Minnesota - Verify that study guide is accessible without registration
	 * */ 
	@Test
	private void MN_Navigate_To_StudyGuide_Page() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 3 : Minnesota - Verify that study guide is accessible without registration"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 3 : Minnesota - Verify that study guide is accessible without registration"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 1: Navigated to /Minnesota page ");
		Reporter.log("Step 1: Navigated to /Minnesota page"); 
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL.substring(5) + "/minnesota" + "/studyGuide/";
	...
	/* Test 4: 
	 * Minnesota  -  Student Requirements - Verify that user can pay with International Address
	 * */ 
	@Test
	private void MN_Stds_Req_International_Address() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 4 : Minnesota  -  Student Requirements - Verify that user can pay with International Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 4 : Minnesota  -  Student Requirements - Verify that user can pay with International Address"  + "\n" +
				 	  "====");	
	...
	/* Test 5: 
	 * Minnesota -  Student Requirements - Verify that minimum age limit for sign up is 12 years 
	 * */ 
	@Test
	private void MN_Stds_Req_AgeLimit() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 5 : Minnesota -  Student Requirements - Verify that minimum age limit for sign up is 12 years "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 5 : Minnesota -  Student Requirements - Verify that minimum age limit for sign up is 12 years  "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 2 : Filling registration form (with Age < minimum age required) and clicking on 'Create Account' button"); 
			...
			String username="MN"+ JH.GenerateRandomNumber();
		...
		Reporter.log("Step 5 : Filling registration form (with Age > minimum age required) and clicking on 'Create Account' button"); 
			...
			username="MN"+ JH.GenerateRandomNumber();
	...
	/* Test 6: 
	 * Minnesota -  Verify that student is asked for payment only once user has passed the online exam
	 * */ 
	@Test
	private void MN_AskedForPaymentAfterPassingExam() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 6 : Minnesota -  Verify that student is asked for payment only once user has passed the online exam"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 6 : Minnesota -  Verify that student is asked for payment only once user has passed the online exam"  + "\n" +
				 	  "====");	
	...
	/* Test 7: 
	 * Minnesota -  Verify the course fee 
	 * */ 
	@Test
	private void MN_VerifyFeeAndTaxes() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 7 : Minnesota -  Verify the course fee "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 7 : Minnesota -  Verify the course fee "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			System.out.println(username);
			String emailprefix = "MN" + JH.GenerateRandomNumber();
	...
	/* Test 8: 
	 * Minnesota  - Verify the course has a Practice Exam
	 * */ 
	@Test
	private void MN_VerifyPraticeExam() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 8 : Minnesota  - Verify the course has a Practice Exam"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 8 : Minnesota  - Verify the course has a Practice Exam"  + "\n" +
				 	  "====");	
