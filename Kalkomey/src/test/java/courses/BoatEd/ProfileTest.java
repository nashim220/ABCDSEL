...
public class ProfileTest 
{
	...
	*/ 
	...
	private void Profile_ResetPassword() throws Exception
	{
		...
		Reporter.log("Step 9 : Verifying whether user is logged successfully or not"); 
			...
			if(SeleniumFunc.IsElementPresent("css", "body > header > div > div > div > nav > ul > li:nth-child(4) > a"))
				{
			...
			String ActualUserName=SeleniumFunc.GetElementText("css", "body > header > div > div > div > nav > ul > li:nth-child(4) > a").trim();
	...
	*/ 
	...
	private void Profile_Edit1() throws Exception
	{
		...
		System.out.println("Step 3 : Editing all fields (i.e. Gender, Student SSN, Email Address, Mailing Address) and clicking on 'Update Profile' button");
		Reporter.log("Step 3 : Editing all fields (i.e. Gender, Student SSN, Email Address, Mailing Address) and clicking on 'Update Profile' button");
	...
	*/ 
	...
	private void Profile_CountryDropdown_Values() throws Exception
	{
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			String username= "profileboat" + JH.GenerateRandomNumber();
			System.out.println(username);
			String emailprefix = "profileboat" + JH.GenerateRandomNumber();
			String emailaddress= emailprefix + "@mailinator.com";
			String password = "clarion@123";
