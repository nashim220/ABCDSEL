	...
	private void PracticeExam_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying UI elements on Practice Exam page");
			...
			*/
			...
			if(practiceexam.FinalExam.getText().trim().contains("Final Exam"))
			{
			...
			if(practiceexam.TakePracticeExam.getText().trim().contains("Begin the Practice Exam →"))
			{
				...
				Reporter.log("-- 'Take the Practice Exam' button is present");
			}
			else
			{
	...
	*/ 
	...
	private void FinalExam_UI_Buttons() throws Exception
	{
		...
		Reporter.log("Step 6 : On Final Exam page, clicking 'Begin Final Exam' button");
			...
			String actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			String expectedtext = "Boating License Certification Exam / Question 1 of 60";
	...
	private void FinalExam_ResumeExam() throws Exception
	{
		...
		Reporter.log("Step 6 : Log out and login again to application");
			...
			//verifying page header
			if(finalexam.PageTitle.getText().trim().equals("Boating License Certification Exam") )
			{
				System.out.println("-- User is navigated to Final Exam"  );
				Reporter.log("-- User is navigated to Final Exam");
			}
			...
			{
				System.out.println("-- 'Continue Boating License Certification Exam' button is present"  );
				Reporter.log("-- 'Continue Boating License Certification Exam' button is present");
			}
			else
			{
				System.out.println("-- 'Continue Boating License Certification Exam' button is NOT present" );
				Reporter.log("-- 'Continue Boating License Certification Exam' button is NOT present");
				AssertFailedCount++;
			}
		...
		Reporter.log("Step 7 : On Final Exam page, clicking 'Continue Boating License Certification Exam' button");
			...
			String actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			expectedtext = "Boating License Certification Exam / Question 2 of 60";
	...
	private void FinalExam_ResultsFail() throws Exception
	{
		...
		System.out.println("Step 5 : On Final exam question page ,selecting incorrect answers and moving to next questions" );
		Reporter.log("Step 5 : On Final exam question page , selecting incorrect answers and moving to next questions");
		...
		Reporter.log("Step 3 : Verifying Final Exam result page when result = Fail");
			...
			//verifying header
			String expectedtext = "Boating License Certification Exam";
			...
			expectedtext = "See a Critique of Your Boating License Certification Exam Results";
	...
	private void FinalExam_ResultsFail_SeeCritique() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Critique page");
			...
			//verifying page header
			String actualtext = SeleniumFunc.GetElementText("css", "div.page-header h1");
			String expectedtext = "Boating License Certification Exam Critique";
		...
		Reporter.log("Step 5 : Clicking 'Back to the Exam Results' button");
			...
			Thread.sleep(4000);
				...
				//verifying header
				expectedtext = "Boating License Certification Exam";
	...
	private void FinalExam_ResultsPass() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Final Exam result page when result = Pass");
			...
			//verifying "Next, get your Proof of Home Study Voucher" message
			
			expectedtext = "Next, get your Proof of Home Study Voucher";
			actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] h2");
			
			if(actualtext.equals(expectedtext))
			{
				System.out.println("-- Success !! 'Next, get your Proof of Home Study Voucher' message displayed ");
				Reporter.log("-- Success !! 'Next, get your Proof of Home Study Voucher' message displayed ");
			}
			else
			{
				System.out.println("-- Failure !! 'Next, get your Proof of Home Study Voucher.' message not displayed  and instead displayed - > " + actualtext);
				Reporter.log("-- Failure !! 'Next, get your Proof of Home Study Voucher.' message not displayed  and instead displayed - > " + actualtext);
				AssertFailedCount++;
			}
	...
	/* Test 14: 
	 * Final Exam : To verify max exam attempts for Florida Violator 
	 * */ 
	@Test
	private void FinalExam_MaxAttemptFV() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 14 : Final Exam : To verify max exam attempts for Florida Violator "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 14 : Final Exam : To verify max exam attempts for Florida Violator "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			for (int i=1;i<4;i++)
			{
				...
				if(i<3)
				{
					expectedtext = "You have now failed the Certification Exam " + i + " time(s). You are allowed a total of 3 failures before you fail the entire course and will have to take the entire course again.";
					actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] p:nth-of-type(1)");
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! user is allowed to attemp exam 3 times");
						Reporter.log("-- Success !! user is allowed to attemp exam 3 times");
					}
					else
					{
						System.out.println("-- Failure !! user is NOT allowed to attemp exam 3 times . Expected : " + expectedtext + "Actual : "+ actualtext);
						Reporter.log("-- Failure !! user is NOT allowed to attemp exam 3 times . Expected : " + expectedtext + "Actual : "+ actualtext);
						AssertFailedCount++;
					}
				...
				else
				{
					...
					expectedtext = "You have now failed the Certification Exam a total of 1 time(s), which means that you have failed the course. In order to pass the course at this point, you will need to re-register for the course again and start from the very beginning";
					actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] p:nth-of-type(1)");
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! user is NOT allowed to attemp exam 4th time");
						Reporter.log("-- Success !! user is NOT allowed to attemp exam 4th time");
						
						expectedtext = "Re-register to repeat the course now";
						actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] a[class='btn']");
					
						if(actualtext.equals(expectedtext))
						{
							System.out.println("-- Success !! 'Re-register to repeat the course now' button is present  " );
							Reporter.log("-- Success !! 'Re-register to repeat the course now' button is present");
						}
						else
						{
							System.out.println("-- Failure !! 'register to repeat the course now' button is NOT present . Expected : " + expectedtext + "Actual : "+ actualtext);
							Reporter.log("-- Failure !! 'register to repeat the course now' button is NOT present . Expected : " + expectedtext + "Actual : "+ actualtext);
							AssertFailedCount++;
						}
					}
					else
					{
						System.out.println("-- Failure !! user is allowed to attemp exam 4th time . Expected : " + expectedtext + "Actual : "+ actualtext);
						Reporter.log("-- Failure !! user is allowed to attemp exam 4th time  . Expected : " + expectedtext + "Actual : "+ actualtext);
						AssertFailedCount++;
					}
				}
	...
	/* Test 15: 
	 * Final Exam :  Final Exam : To verify max exam attempts for Boat Oregon Course
	 * */ 
	@Test
	private void FinalExam_MaxAttemptOR() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 15 :  Final Exam : To verify max exam attempts for Boat Oregon Course"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 15 :  Final Exam : To verify max exam attempts for Boat Oregon Course"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			for (int i=1;i<3;i++)
			{
				...
				if(i<2)
				{
					...
					//Clicking on Begin the Certification Exam
					SeleniumFunc.ClickOnElement("css", "#next_text a");						Thread.sleep(4000);
				...
				else
				{
					...
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! user is NOT allowed to attemp exam 3th time");
						Reporter.log("-- Success !! user is NOT allowed to attemp exam 3th time");
						
					}
					else
					{
						System.out.println("-- Failure !! user is allowed to attemp exam 3th time . Expected : " + expectedtext + "Actual : "+ actualtext);
						Reporter.log("-- Failure !! user is allowed to attemp exam 3th time  . Expected : " + expectedtext + "Actual : "+ actualtext);
						AssertFailedCount++;
					}
				}
