...
public class TennesseeTest 
{
	...
	/* Test 1: 
	 * tennessee  - Verify State Agency name on /tennessee page
	 * 
	 */ 
	@Test
	private void TN_VerifyAgencyName() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 1 : tennessee - Verify State Agency name on /tennessee page"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 1 : tennessee - Verify State Agency name on /tennessee page"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 1: Navigated to /tennessee page and verifying State Agency name");
		Reporter.log("Step 1: Navigated to /tennessee page and verifying State Agency name"); 
			
			
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL + "/tennessee");
			Thread.sleep(4000);
			...
			String expectedtext = "Tennessee Wildlife Resources Agency";
			String actualtext = home.AgencyName_New.getText().trim();
	...
	/* Test 2: 
	 * tennessee - Verify that study guide is accessible without registration
	 * */ 
	@Test
	private void TN_Navigate_To_StudyGuide_Page() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : tennessee - Verify that study guide is accessible without registration"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : tennessee - Verify that study guide is accessible without registration"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 1: Navigated to /tennessee page");
		Reporter.log("Step 1: Navigated to /tennessee page"); 
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL.substring(5) + "/tennessee" + "/studyGuide/";
	...
	/* Test 3: 
	 * tennessee  -  Student Requirements - Verify that user can pay with International Address
	 * */ 
	@Test
	private void TN_Stds_Req_International_Address() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 3 : tennessee  -  Student Requirements - Verify that user can pay with International Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 3 : tennessee  -  Student Requirements - Verify that user can pay with International Address"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL + "/tennessee");
		Reporter.log("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL + "/tennessee"); 
			...
			String username="tennessee"+ JH.GenerateRandomNumber();
	...
	/* Test 4: 
	 * Tennessee -  Student Requirements - Verify that student should be  born after 01-01-1989 to sign up
	 * */ 
	@Test
	private void TN_Stds_Req_AgeLimit() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 4 : Tennessee -  Student Requirements - Verify that student should be  born after 01-01-1989 to sign up"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 4 : Tennessee -  Student Requirements - Verify that student should be  born after 01-01-1989 to sign up "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 4 : Verifying whether correct validation message is displayed or not"); 
			...
			String ExpectedValidationMessage = "You must have been born on or before January 1, 1989, to register for this course.";
		...
		Reporter.log("Step 5 : Filling registration form (with Age > minimum age required) and clicking on 'Create Account' button"); 
			...
			username="TN"+ JH.GenerateRandomNumber();
			register.FillRegistrationForm(username, "piyush@143", "piyush@143", "test", "B", "Patel", "Jr.", "January", "1", "1988","testing@gmail.com", "testing@gmail.com");
			register.ClickOnCreateAccount();
	...
	/* Test 5: 
	 * tennessee -  Verify the course fee 
	 * */ 
	@Test
	private void TN_VerifyFeeAndTaxes() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 5 : tennessee -  Verify the course fee "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 5 : tennessee -  Verify the course fee "  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			register.RegisterAsNewUser(username, password, password, "test", "B", "ke-testing", "Jr.", "January", "2", "1980", emailaddress, emailaddress);
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , , verfiying Course Fee");
			...
			//Verifying Boat tennessee Course Fee
			String expectedtext = "$29.50";
			String actualtext = payinfo.CourseFee_Fee.getText().trim();
			
			if(actualtext.equals(expectedtext))
			{
				System.out.println("-- Success !! Boat tennessee Course Fee  is correct i.e. " + actualtext );
				Reporter.log("-- Success !! Boat tennessee Course Fee is correct i.e. " + actualtext );
			}
			else
			{
				System.out.println("-- Failure !! Boat tennessee Course Fee is incorrect . Expected is : " + expectedtext + " , Actual is : " + actualtext );
				Reporter.log("-- Failure !! Boat tennessee Course Fee is incorrect . Expected is : " + expectedtext + " , Actual is : " + actualtext);
				AssertFailedCount++;
			}
