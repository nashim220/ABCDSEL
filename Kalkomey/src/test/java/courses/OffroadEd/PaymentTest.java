...
public class PaymentTest 
{
	...
	private void PaymentStage1_UI_Verification() throws Exception
	{
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information , verfiying UI/Text information");
			...
			String expectedtext = "Your Application for the Arizona OHV Safety Certificate";
			...
			expectedtext = "Test B Ke-testing Jr.";
	...
	/* Test 3: 
	 * Certification Information - Stage 1 : Verify validation message for invalid values for Zip, Phone Number fields
	 * */ 
	@Test
	private void PaymentStage1_Validation_InvalidInputs() throws Exception
	{
		...
		System.out.println("Step 4 : On Application page - Stage 1 : Certification Information ,  entering invalid values for SSN, Zip, Phone Number fields" );
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information ,  entering invalid values for SSN, Zip, Phone Number fields");
	...
	private void PaymentStage1_ConfirmationPopUpDatails() throws Exception
	{
		...
		Reporter.log("Step 5 : Clicking on 'Confirm Cerification Information' button and verifying details on 'Confirm Your Certificate Information' model");
			...
			//Verifying user's name
			String expectedtext = "Test B Ke-testing Jr.";
	...
	private void PaymentStage1_ConfirmationPopUpDatails_Phy_Address() throws Exception
	{
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information ,  entering User info, Contact info.");
			...
			cerinfo.EnterPhysicalAddress("28261 P", "PY 10003", "Pew York", "Alabama", "33333", "United States of America", "333-567-8910");	
		...
		Reporter.log("Step 6 : Clicking on 'Make Change' button and updating details again.");
			...
			cerinfo.Student_SSN.sendKeys("123-45-1111");
			
			cerinfo.EnterMailingAddress("28211 N", "NY 10011", "New City", "Alabama", "22222", "United States of America", "234-567-1111");
			
			//De-selecting Physical Address checkbox
		...
		Reporter.log("Step 7 : Clicking on 'Confirm Cerification Information' button and verifying details on 'Confirm Your Certificate Information' model");
			...
			//Verifying SSN
			expectedtext = "123-45-1111";
			actualtext = cerinfo.ConfirmCertificateInformationModal_SSN.getText().trim();
			
			if(actualtext.equals(expectedtext))
			{
				System.out.println("-- Success !! SSN is correct i.e. " + actualtext );
				Reporter.log("-- Success !! SSN is correct i.e. " + actualtext );
			}
			else
			{
				System.out.println("-- Failure !! SSN is incorrect . Expected is : " + expectedtext + " , Actual is : " + actualtext );
				Reporter.log("-- Failure !! SSN is incorrect . Expected is : " + expectedtext + " , Actual is : " + actualtext);
				AssertFailedCount++;
			}
			
			
			//Verifying Mailing Address
			expectedtext = 	"28211 N" + "\n" +
							"NY 10011"+ "\n" +
							"New City, AL 22222"+ "\n" +
							"United States of America"+ "\n" +
							"Phone: 234-567-1111";
			...
			try
			{
				actualtext = cerinfo.ConfirmCertificateInformationModal_PhysicalAddress.getText().trim();
					...
					System.out.println("-- Failure !! Physical Address displayed ");
					Reporter.log("-- Failure !! Physical Address displayed ");
					AssertFailedCount++;
				
			}
			catch(Exception e)
			{
				System.out.println("-- Success !! Physical Address not displayed ");
				Reporter.log("-- Success !! Physical Address not displayed ");
	...
	private void PaymentStage1_EditUpdateFields() throws Exception
	{
		...
		System.out.println("Step 2: Updating user profile");
		Reporter.log("Step 2: Updating user profile"); 
			
		
			SeleniumFunc.ToGoToUrl(Constants.ProfilePage_Offroad);
			Thread.sleep(4000);
	...
	private void PaymentStage2_UI_Verification() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , , verfiying UI/Text information");
			...
			String expectedtext = "Your Payment for the Arizona OHV Safety Certificate";
			...
			expectedtext = "Arizona Offroad Ed Course Fee";
	...
	private void PaymentStage2_Validation_InvalidInputs() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , entering invalid values for CC , Zip , Phone Number fields");
			...
			/*System.out.println("-- Entering invalid values to CC fields - CC Expriration Date");
			Reporter.log("-- Entering invalid values to CC fields - CC Expriration Date");
				
				driver.navigate().refresh();
				new Select(payinfo.ExpirationMonth).selectByIndex(2);
				new Select(payinfo.ExpirationYear).selectByIndex(2);
				
				payinfo.ConfirmPaymentInformation.click();
		
				ActualValidationMessage= SeleniumFunc.GetElementText("css", "div.errorMessageTarget p").trim();
				//System.out.println(ActualValidationMessage);
				...
				if(ActualValidationMessage.equals(ExpectedValidationMessage))
				{
					System.out.println("-- Success !! correct validation messages are displayed for CC Expriration Date field i.e. " + ActualValidationMessage);
					Reporter.log("-- Success !! correct validation messages are displayed for CC Expriration Date field i.e. " + ActualValidationMessage); 
				}
				else
				{
					System.out.println("-- Failure !!  Incorrect validation messages are displayed for CC Expriration Date field" + "\n" + "Expected Validation messages : "  
										+ "\n" + ExpectedValidationMessage + "\n" + 
										 "Actual Validation messages : " + "\n" +  ActualValidationMessage);
					Reporter.log("-- Failure !!  Incorrect validation messages are displayed for CC Expriration Date field" + "\n" + "Expected Validation messages : "  
							+ "\n" + ExpectedValidationMessage + "\n" + 
							 "Actual Validation messages : " + "\n" + ActualValidationMessage); 
	...
	private void PaymentStage2_ConfirmationPopUpDatails() throws Exception
	{
		...
		Reporter.log("Step 6 : Clicking on 'Payment Cerification Information' button and verifying details on 'Confirm Your Payment Information' model");
			...
			expectedtext = "Acceptance of Terms" + "\n" + 
							"I understand that I will be charged the total amount listed and that there are no refunds or cancellations. I agree to these terms.";
	...
	private void PaymentStage2_PayWithCoupon() throws Exception
	{
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , entering valid Coupon code and clicking on 'Apply Code' button");
			...
			expectedtext = Constants.ApplicationURL_Offroad + "/register/paymentconfirm/payment/";
	...
	private void PaymentStage2_PaymentConfirmationEmail() throws Exception
	{
		...
		Reporter.log("Step 6 : Navigating to Email Box and verifying whether payment confirmation email is received with correct details or not"); 
			...
			String ExpectedMessageTitle="Offroad Ed " +Constants.State_Offroad.substring(1, Constants.State_Offroad.length()) + " Course - Customer Receipt"; 
			...
			try
			{
				...
				String ExpectedMessageBody =
						"Hi test," + "\n" + "\n" +
						"Thank you for taking the Boat " + Constants.State_Offroad.substring(1, Constants.State_Offroad.length())+ " Course. Details of your payment appear below." + "\n" + "\n" + "\n" +
				...
				String ExpectedMessageBody1 =
						"Description: Boat " + Constants.State_Offroad.substring(1, Constants.State_Offroad.length())+ " Course" + "\n" + "\n" + "\n" +
	...
	private void PaymentStage3_ViewReceiptPageDetails() throws Exception
	{
		...
		Reporter.log("Step 6 : Verifying details on 'View Receipt' page"); 
			...
			// Verifying presence of 'Get Your Temporary OHV Safety Certificate' button
			
					expectedtext = "Get Your Temporary OHV Safety Certificate";
					actualtext = receipt.GetYourProofofHomeStudyVoucher.getText().trim();
					
					if(actualtext.contains(expectedtext))
					{
						System.out.println("-- Success !! 'Get Your Temporary OHV Safety Certificate' button  is present i.e. " + actualtext );
						Reporter.log("-- Success !! 'Get Your Temporary OHV Safety Certificate' button  is present i.e. " + actualtext );
						
					}
					else
					{
						System.out.println("-- Failure !! 'Get Your Temporary OHV Safety Certificate' button  is NOT present. Expected is : " + expectedtext + " , Actual is : " + actualtext );
						Reporter.log("-- Failure !! 'Get Your Temporary OHV Safety Certificate' button  is NOT present. " + expectedtext + " , Actual is : " + actualtext);
						AssertFailedCount++;
					}
			...
			// Verifying details under 'Bill To' section i.e. User's name, Billing address , total Amount, Course Fee , Total Fee
					...
					//Total Amount
					expectedtext = "Total Amount: $29.50";
	...
	/* Test 19: 
	 * View Receipt - Stage 3 :  Verify on click to 'Get Your Temporary OHV Safety Certificate ' button , user is navigated to Course Complete page
	 * */ 
	@Test
	private void PaymentStage3_NavigateToCourseCompeletePage() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 19 : View Receipt - Stage 3 :  Verify on click to 'Get Your Temporary OHV Safety Certificate ' button , user is navigated to Course Complete page"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 19 : View Receipt - Stage 3 :  Verify on click to 'Get Your Temporary OHV Safety Certificate ' button , user is navigated to Course Complete page"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 6 : On 'View Receipt' page, clicking on 'Get Your Temporary OHV Safety Certificate ' button");
		Reporter.log("Step 6 : On 'View Receipt' page, clicking on 'Get Your Temporary OHV Safety Certificate ' button"); 
			
			receipt.GetYourProofofHomeStudyVoucher.click();
			Thread.sleep(4000);
			
			//Verifying Url
			String expectedtext = Constants.ApplicationURL_Offroad + "/course/course_complete/";
			String actualtext = driver.getCurrentUrl();
			...
			if(actualtext.contains(expectedtext))
			{
				...
				expectedtext = "You Have Completed the Arizona Offroad Ed Course";
	...
	private void PaymentStage3_VerifyCourseCompeletePage() throws Exception
	{
		...
		Reporter.log("Step 7 : On 'View Receipt' page, verifying details");
			...
			//Verifying congratulation message
				...
				expectedtext = "Congratulations, you have successfully completed the Arizona Offroad Ed Course. You may now download your Arizona Temporary OHV Safety Certificate or have it sent to your registered e-mail address.";
			...
			//Verifying presence of 'Download' button
				...
				expectedtext = "Download the Arizona Temporary OHV Safety Certificate";
			...
			//Verifying presence of 'Email' button
				...
				expectedtext = "E-mail the Arizona Temporary OHV Safety Certificate";
			...
			//Verifying presence of 'return to the course contents' links .
				...
				actualtext = coursecomplete.ReturnToCourseContent_Offroad.getText().trim();
	 ...
	 * */ 
	@Test
	private void BillingInfoPersistAfterCoupon_Offroad() throws Exception
	{
		System.out.println("====" + "\n" +
