...
public class StudyGuideTest 
{
	 ...
	 * */ 
	@Test(dataProvider="StudyGuide_Offroad",dataProviderClass=utility.TestNG.class)
			...
			try
			{
				...
				if(actualtext.contains(expectedtext))
				{
					...
					Reporter.log("Step 3 : Click on 'Study Guide' link");
						...
						expectedtext = Constants.ApplicationURL_Offroad.substring(5) + state + "/studyGuide/";
	...
	private void StudyGuide_Content_Verification() throws Exception
	{
		...
		Reporter.log("Step 3 : Verifying contents on 'Study Guide' page");
			...
			//Verifying about sections i.e. title text, body, Learn More button, Register for the Course button
				...
				if(actualtext.startsWith("You are looking at a preview of") && actualtext.contains("Arizona Offroad Ed Course") && actualtext.endsWith("your Arizona OHV Safety Certificate."))
				{
		 ...
		 // Verifying content section title
				expectedtext = "Study Guide for Arizona OHV Safety Certificate";
		...
		Reporter.log("Step 4 : Clicking on 'Learn More' button");
			...
			expectedtext = Constants.ApplicationURL_Offroad.substring(5) + Constants.State_Offroad;
			actualtext = driver.getCurrentUrl();
		...
		Reporter.log("Step 5 : Clicking on 'Register for the Course' button");
			...
			expectedtext = Constants.ApplicationURL_Offroad.substring(5) + "/register/create";
			actualtext = driver.getCurrentUrl();
