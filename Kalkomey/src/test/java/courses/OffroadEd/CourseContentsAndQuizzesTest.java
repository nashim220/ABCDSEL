...
public class CourseContentsAndQuizzesTest 
{
	...
	*/ 
	...
	{
		System.out.println("====" + "\n" +
					"Test :Verify that 'Continue where you left off' button is displayed and working as expected "  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test : Verify that 'Continue where you left off' button is displayed and working as expected"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 5 : Navigating to Contents page and verifying whether 'Continue where you left off' button is displayed and on click to it, user is navigated to correct page"); 
			...
			if(SeleniumFunc.IsElementPresent("css", ".btn.btn-small"))
			{
				System.out.println("Success !! 'Continue where you left off' Button is present");
				Reporter.log("Success !! 'Continue where you left off' Button is present");
				
				String ExpectedText = "Continue where you left off";
				String ActualText= SeleniumFunc.GetElementText("css", ".btn.btn-small").trim();
				...
				{
					System.out.println("Failure !! 'Continue where you left off' Button text is incorrect : " + ActualText);
					Reporter.log("Failure !! 'Continue where you left off' Button text is incorrect " + ActualText);
					AssertFailedCount++;
				}
				
				SeleniumFunc.ClickOnElement("css", ".btn.btn-small");
				Thread.sleep(4000);

				//Verifying whether user is navigated to correct page or not
				
				ExpectedText = "Page 3 of 3";
	...
	*/ 
	...
	private void Contents_VerifyUnitTopicPageNumber() throws Exception
	{
		...
		System.out.println("Step 2 : On Contents page, verify that Unit/Topic/Page number correctly displayed on contents page");
		Reporter.log("Step 2 : On Contents page, verify that Unit/Topic/Page number correctly displayed on contents page"); 
			
			
		
			for (int i=1;i<4;i++)
			{
				String ExpectedText = "Unit 1 of 7";
	...
	*/ 
	...
	private void Contents_NavigateNextPreviousPages() throws Exception
	{
		...
		System.out.println("Step 5 : On Contnets page, verify that user can navigate to 'Next' & 'Previous' pages");
		Reporter.log("Step 5 : On Contnets page, verify that user can navigate to 'Next' & 'Previous' pages"); 
	...
	*/ 
	...
	private void Contents_NextButton_Timer_Tooltip() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether timer is displayed on 'Next' button"); 
				...
				String ActualText= SeleniumFunc.GetElementText("css", "li.next a.timer").trim();
	...
	*/ 
	...
	private void Quiz_IntroductionPage() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and marking Unit 1 as complete. Navigating back to Contents page"); 
			...
			keadmin.StudentSearchAndActivity(username, "Off-Road", "Progress");
	...
	*/ 
	...
	Reporter.log("Step 8 : Clicking 'Back to the Quiz Results' button");
		...
		tempurl2="https://qa1.offroad-ed.com/exam/quiz/700063698/?override_reset=1";
		SeleniumFunc.ClickOnElement("css", "#prev_text a");
		Thread.sleep(4000);
	...
	*/ 
	...
	private void Contents_ContentVerification() throws Exception
	{
		...
		Reporter.log("Step 2 : On Contents page, verifying Page Header, Introduction Text, Units, Exams related text"); 
			...
			//Verifying Page header
				...
				String expected = "Arizona Offroad Ed Course";
			...
			//Verifying Introduction text
				actual= SeleniumFunc.GetElementText("css", "div [class='span8 offset2'] p:nth-of-type(1)").trim()  +  SeleniumFunc.GetElementText("css", "div [class='span8 offset2'] p:nth-of-type(2)").trim() ;			
				//expected = "If you are here for the first time, you'll see the first unit and topic already “opened” for you to click to begin. The next page in your Course Contents progress list will become available as you complete each page. To move to the next page, simply click on the Next button.If you are returning to the course, the unit/topic where you need to resume study is already “opened” for you to click. You also may click on a unit/topic in the list below to access a page you've already completed." ; 
				//String expected1 = "button at the bottom of each page.";
				//String expected2 = "If you are here for the first time, you'll see the first unit and topic already “opened” for you to click to begin. The next page in your Course Contents progress list will become available as you complete each page. To move to the next page, simply click on the Next button.If you are returning to the course, the unit/topic where you need to resume study is already “opened” for you to click. You also may click on a unit/topic in the list below to access a page you've already completed.";
						
				//if(actual.contains(expected) && actual.contains(expected2) && actual.contains(expected1))
				if(actual.startsWith("If you are here for the first time, you") && actual.contains("see the first unit and topic already") && actual.contains("for you to click to begin. The next page in your Course Contents progress list will become available as you complete each page. To move to the next page, simply click on the Next button.If you are returning to the course, the unit/topic where you need to resume study is already "))
				{
				...
				{
					System.out.println("Failure !! Introduction text is incorrect . Actual is : " + actual);
					Reporter.log("Failure !! Introduction text is incorrect . Actual is : " + actual); 
					AssertFailedCount++;
				}	
			...
			//Verifying Exam text	
				...
				expected = "Practice Exam" + "Certification Exam";
					
				if(actual.contains(expected))
				{
					
					System.out.println("Success !! 'Certification Exam' and 'Practice Exam' links are present");
					Reporter.log("Success !! 'Certification Exam' and 'Practice Exam' links are present");
				}
				else
				{
					System.out.println("Failure !!  'Certification Exam' and 'Practice Exam' links are NOT present. Expected is : " + expected + "\n" + "Actual is : " + actual);
					Reporter.log("Failure !! 'Certification Exam' and 'Practice Exam' links are NOT present. Expected is : " + expected + "\n" + "Actual is : " + actual); 
					AssertFailedCount++;
				}
	...
	private void Contents_TimedCourseVerification() throws Exception
	{
		...
		System.out.println("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL_Offroad +Constants.State_Offroad);
		Reporter.log("Step 1 : Navigate to Registration page : " + Constants.ApplicationURL_Offroad + Constants.State_Offroad); 
		...
		Reporter.log("Step 2 : Register as a New user"); 
			...
			Thread.sleep(8000);
			System.out.println("Registered with user : "+username);
			if(SeleniumFunc.IsElementPresent(content.IntroModal))
			{
				content.IntroModal.click();
				Thread.sleep(4000);
		...
		Reporter.log("Step 5 : Verifying whether timer is displayed on 'Next' button"); 
				...
				//String ExpectedText = "Remaining"; 
			//	String ActualText= content.timer.getText().trim();		
	
				if(SeleniumFunc.IsElementPresent(content.timer))
				{
		...
		Reporter.log("Step 7 : Navigating back to Contents page and Expanding Unit 1, Expanding Topic 1 , clicking on Page 1 link"); 
			...
			try
			{
				String expectedurl = content.Timed_GetUnitHrefLink(1, 1, 3)+"/";
				content.ContinueWhereYouLeftOff.click();
				
				Thread.sleep(5000);
				String Actualurl= driver.getCurrentUrl();
				System.out.println("Expected : "+expectedurl.trim()+"\nActual :"+Actualurl.trim());
				
	
				if(Actualurl.trim().equalsIgnoreCase(expectedurl.trim()))
				{
					System.out.println("Success !! User is navigated to Unit 1 > Topic 1 > Page 3" );
					Reporter.log("Success !! User is navigated to Unit 1 > Topic 1 > Page 3");		
								
				}
				else
				{
					System.out.println("Failure !! User is NOT navigated to Unit 1 > Topic 1 > Page 3"+" \nActual:"+Actualurl+"\nexpected :"+expectedurl);
					Reporter.log("Failure !! User is NOT navigated to Unit 1 > Topic 1 > Page 3"+" \nActual:"+Actualurl+"\nexpected :"+expectedurl);
					AssertFailedCount++;
				}
