...
public class CertificateTest 
{
	...
	private void Certificate_Email() throws Exception
	{
		...
		Reporter.log("Step 7 : On 'View Receipt' page, click on 'Email' button");
			...
			expectedtext = "Your Temporary OHV Safety Certificate has been sent to your e-mail address " + emailaddress + ".";
		...
		Reporter.log("Step 8 : Verifying whether Email is received by user or not");
			...
			String ExpectedMessageTitle="Offroad Ed " +Constants.State_Offroad.substring(1, Constants.State_Offroad.length()) + " Course Temporary OHV Safety Certificate"; 
			...
			try
			{
				...
				String ExpectedMessageBody =
						"Hi test," + "\n" + "\n" +
						"Congratulations on passing the Offroad Ed " + Constants.State_Offroad.substring(1, Constants.State_Offroad.length())+ " Course. Your Temporary OHV Safety Certificate is attached." + "\n" + "\n" + 
