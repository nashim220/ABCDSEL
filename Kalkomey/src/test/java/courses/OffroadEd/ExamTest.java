	...
	private void PracticeExam_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying UI elements on Practice Exam page");
			...
			*/
			...
			{
				System.out.println("-- 'Go to the Certification Exam' button is present"  );
				Reporter.log("-- 'Go to the Certification Exam' button is present");
			}
			else
			{
	...
	*/ 
	...
	private void FinalExam_ResumeExam() throws Exception
	{
		...
		Reporter.log("Step 6 : Log out and login again to application");
			...
			//verifying page header
			if(finalexam.PageTitle.getText().trim().equals("Certification Exam") )
			{
				System.out.println("-- User is navigated to Final Exam"  );
				Reporter.log("-- User is navigated to Final Exam");
			}
			...
			{
				System.out.println("-- 'Continue Certification Exam' button is present"  );
				Reporter.log("-- 'Continue Certification Exam' button is present");
			}
			else
			{
				System.out.println("-- 'Continue Certification Exam' button is NOT present" );
				Reporter.log("-- 'Continue Certification Exam' button is NOT present");
				AssertFailedCount++;
			}
		
		
		System.out.println("Step 7 : On Final Exam page, clicking 'Continue Certification Exam' button" );
		Reporter.log("Step 7 : On Final Exam page, clicking 'Continue Certification Exam' button");
			...
			String actualtext = SeleniumFunc.GetElementText("css", "ul.breadcrumb");
			expectedtext = "Certification Exam / Question 2 of 50";
					
			//verifying url
			if(actualtext.equals(expectedtext))
			{
				System.out.println("-- On click to the 'Continue Certification Exam' button, user is navigated to Question 2 page"  );
				Reporter.log("-- On click to  the 'Continue Certification Exam' button , user is navigated to Question 2 page");
			}
			else
			{
				System.out.println("-- On click to the 'Continue Certification Exam' button, user is navigated to Question 2 page and navigated to : " + driver.getCurrentUrl()  );
				Reporter.log("-- On click to the 'Continue Certification Exam' button , user is navigated to Question 2 page and navigated to :" + driver.getCurrentUrl());
				AssertFailedCount++;
			}
	...
	private void FinalExam_ResultsFail() throws Exception
	{
		...
		Reporter.log("Step 2 : Navigating on KE Cousers Admin and performing 'Fast Forward Fail' and navigating back to Exam result page"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.AdminURL);
			keadmin.StudentSearchAndActivity(username, "Off-Road", "Fast Forward Fail");
	...
	private void FinalExam_ResultsFail_SeeCritique() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Critique page");
			...
			//verifying page header
			String actualtext = SeleniumFunc.GetElementText("css", "div.page-header h1");
			String expectedtext = "Certification Exam Critique";
	...
	private void FinalExam_ResultsPass() throws Exception
	{
		...
		Reporter.log("Step 4 : Verifying Final Exam result page when result = Pass");
			...
			expectedtext = "Next, get your Temporary OHV Safety Certificate";
			actualtext = SeleniumFunc.GetElementText("css", "div[class='span8 offset2'] h2");
