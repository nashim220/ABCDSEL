...
public class ProfileTest 
{
	...
	*/ 
	...
	private void Profile_UIElementVerification() throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Offroad);
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ProfilePage_Offroad); 
		...
		System.out.println("Step 4 : Verifying presence sections : 'Your Offroad Ed Account' and 'Account Information' ");
		Reporter.log("Step 4 : Verifying presence sections : 'Your Offroad Ed Account' and 'Account Information' "); 	
			
			if(SeleniumFunc.GetElementText("css", "div#main section:nth-of-type(1) h2").equals("Your Offroad Ed Account"))
			{
				
				System.out.println("Success !! 'Your Offroad Ed Account' section is present");
				Reporter.log("Success !! 'Your Offroad Ed Account' section is present"); 
			}
			else
			{
				System.out.println("Failure !! 'Your Offroad Ed Account' section is NOT present");
				Reporter.log("Failure !! 'Your Offroad Ed Account' section is NOT present"); 
				AssertFailedCount++;
			}
	...
	/* Test 2: 
	 * Verify that 'Your Offroad Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address
	*/ 
	@Test
	private void Profile_YourOffroadEdAccountSection() throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Verify that 'Your Offroad Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Verify that 'Your Offroad Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Verifying 'Your Offroad Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address");
		Reporter.log("Step 3 : Verifying 'Your Offroad Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"); 
...
/*			String EyeColor = "Brown";
			...
			profile.EnterWeight(weight);
			profile.SelectEyecolor(EyeColor);
			profile.SelectEthnicity(ethnicity);
			profile.Selecthaircolor(HairColor);
			profile.SelectHeight(Height);
...
*/			profile.SelectGender(gender);
	...
	*/ 
	...
	private void Profile_HideUnhidePhysicalAddress() throws Exception
	{
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage_Offroad);
		Reporter.log("Step 2 : Navigate to Profile page  : " + Constants.ProfilePage_Offroad); 
