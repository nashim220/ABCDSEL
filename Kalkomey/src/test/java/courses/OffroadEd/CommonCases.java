...
public class CommonCases 
{
	...
	{
		System.out.println("====" + "\n" +
					"Test 1 : Home - Verify UI elements on home page e.g. qa1.offroad-ed.com"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 1 : Home - Verify UI elements on home page e.g. qa1.offroad-ed.com"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 1: Navigated to home page and verifying UI elements"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Offroad);
			...
			//Verifying Header 
				...
				String expectedtext = "Offroad-ed.com";
			...
			//Verifying Billboard section 
				...
				expectedtext = "Official Offroad Vehicle Safety Courses";
				/*actualtext = home.Billboard_text.getText();*/
				actualtext = SeleniumFunc.GetElementText("css", "div#hero h1"); 
	...
	private void ErrorPages_Verify500ErrorPage() throws Exception
	{
		...
		Reporter.log("Step 1: Navigated to 500 error page and verifying UI elements"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.Error500Page_Offroad);
			
			
			//Verifying Error Message header 
				
				String expectedtext = "Trail closed�";
			...
			//Verifying "Back to the Home Page" button
				...
				expectedtext = Constants.ApplicationURL_Offroad.substring(5);
			...
			//Verifying "Contact Customer Service" button
				...
				Thread.sleep(5000);
				expectedtext = Constants.ApplicationURL_Offroad.substring(5) + "/site/contact";
				actualtext = driver.getCurrentUrl();
	...
	private void Header_UIElementVarification() throws Exception
	{
		...
		Reporter.log("Step 1: Navigate to application state specific page"); 
			...
			//Verifying Header UI elements
				...
				if(actualtext.startsWith("Arizona OHV Rider") && actualtext.endsWith("Ed Course") )
				{
					System.out.println("Success!! header has correct application name i.e. " + actualtext);
					Reporter.log("Success!! header has correct application name i.e. " + actualtext); 
				}
	...
	private void Home_GetCertifiedIn3StepsSection() throws Exception
	{
		...
		Reporter.log("Step 1: Navigate to application state specific page and verifying presence of  'Get Certified in 3 steps' section"); 
			...
			//Verifying presence of 'Get Certified in 3 steps' section
				...
				String actualtext = driver.findElement(By.cssSelector("#main-steps h1")).getText();
				System.out.println(actualtext);
				...
				actualtext = driver.findElement(By.cssSelector("#main-steps li:nth-of-type(1) p")).getText();
				System.out.println(actualtext);
				...
				//Verifying presence of Step 2 - 'Print your online course completion document.' header text 
				expectedtext = "Print your online course completion document.";
				actualtext = driver.findElement(By.cssSelector("#main-steps li:nth-of-type(2) p")).getText();
				System.out.println(actualtext);
				...
				expectedtext = "Get on the trails!";
				actualtext = driver.findElement(By.cssSelector("#main-steps li:nth-of-type(3) p")).getText();
				System.out.println(actualtext);
	...
	//FUNCTIONALITY CHANGED, DROP-DOWN IS REMOVED 
	/*@Test
	...
	*/
	...
	private void CheaterPage() throws Exception
	{
		...
		Reporter.log("Step 1: Navigated to cheater page and verifying url and text"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL_Offroad + "/answers-to-tests/");
			
			Thread.sleep(4000);

				
				String expectedurl = Constants.ApplicationURL_Offroad.substring(5) + "/answers-to-tests/";
				...
				expectedurl = "Here are all the answers to the Offroad Ed exam. This is the easy way to get your state off-road safety education card, with the correct off-road exam answers!";
	...
	private void Footer_UIElementVarification() throws Exception
	{
		...
		Reporter.log("Step 1: Navigate to application state specific page"); 
			...
			//Verifying Footer UI elements
				...
				//Verifying About Offroad Ed section

				String expectedtext = "The Arizona Offroad Ed Course";
				String actualtext =  SeleniumFunc.GetElementText("css", "#state-course h3");
				System.out.println(actualtext);
	
				if(actualtext.contains(expectedtext) )
				{
					System.out.println("Success!! footer has 'About Offroad Ed' section i.e. " + actualtext);
					Reporter.log("Success!! footer has 'About Offroad Ed' section i.e. " + actualtext); 
				}
				else
				{
					System.out.println("Failure !!  footer doesn't have 'About Offroad Ed' section  " + "\n" + "Expected Text: "  
										+ "\n" + expectedtext + "\n" + 
										 "Actual Text : " + "\n" +  actualtext);
					Reporter.log("Failure !! footer doesn't have 'About Offroad Ed' section " + "\n" + "Expected Text: "  
							+ "\n" + expectedtext + "\n" + 
							 "Actual Text : " + "\n" +  actualtext);
				...
				/*expectedtext = "We work to produce an ATV safety education course that’s accurate, interesting, and easy to understand. Offroad-ed.com is produced by Kalkomey Enterprises, Inc. Kalkomey is a private organization dedicated to providing ATV, ORV, and 4-wheel education courses and certification and publishing ATV safety education materials.";
				actualtext = driver.findElement(By.cssSelector("div#about-program p")).getText();
				System.out.println(actualtext);
	
				if(actualtext.contains(expectedtext) )
				{
					System.out.println("Success!!  'About Offroad Ed' section has correct text i.e. " + actualtext);
					Reporter.log("Success!! 'About Offroad Ed' section has correct text " + actualtext); 
				}
				else
				{
					System.out.println("Failure !! 'About Offroad Ed' section has incorrect text  " + "\n" + "Expected Text: "  
										+ "\n" + expectedtext + "\n" + 
										 "Actual Text : " + "\n" +  actualtext);
					Reporter.log("Failure !! 'About Offroad Ed' section has incorrect text " + "\n" + "Expected Text: "  
							+ "\n" + expectedtext + "\n" + 
							 "Actual Text : " + "\n" +  actualtext);
	...
	private void ErrorPages_Verify404ErrorPage() throws Exception
	{
		...
		Reporter.log("Step 1: Navigated to 404 error page and verifying UI elements"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.Error404Page_Offroad);
	...
	private void State_FAQ() throws Exception
	{
		...
		Reporter.log("Step 1: Navigate to application state specific page and click on 'FAQ' link from header"); 
			...
			if(driver.getCurrentUrl().contains(Constants.ApplicationURL_Offroad.substring(5,Constants.ApplicationURL_Offroad.length() ) + Constants.State_Offroad + "/faq"))
			{
	...
	private void State_Home_UIElementVerification() throws Exception
	{
		...
		Reporter.log("Step 1: Navigated to statehome page and verifying UI elements"); 
			...
			//Verifying Billboard section 
				...
				System.out.println(actualtext);
				// Official Arizona OHV/ORV Safety Course Online
				if(actualtext.startsWith("Official Arizona OHV") && actualtext.contains("ORV"))
				{
					System.out.println("Success!! Billboard has correct text i.e. " + actualtext);
					Reporter.log("Success!! Billboard has correct text  i.e. " + actualtext); 
				}
			...
			//verifying presence of '1-2-3 steps for completeion of course' section
				...
				String expectedtext = "Get OHV/ORV certified in 3 steps." ;
				actualtext = home.State_CompletionSteps_Section.getText().trim();
				//System.out.println(actualtext);
			...
			//verifying presence of 'What To Expect From This Course' section
				
				expectedtext = "What to Expect From Offroad Ed" ;
				actualtext = home.WhatToExpet_Offroad.getText().trim();
				System.out.println(actualtext);
	
				if(actualtext.contains(expectedtext) )
				{
					System.out.println("Success!! 'What To Expect From This Course' section has correct text i.e. " + actualtext);
					Reporter.log("Success!!'What To Expect From This Course' section has correct text  i.e. " + actualtext); 
				}
				else
				{
					System.out.println("Failure !! 'What To Expect From This Course' section has incorrect text  " + "\n" + "Expected Text: "  
										+ "\n" + expectedtext + "\n" + 
										 "Actual Text : " + "\n" +  actualtext);
					Reporter.log("Failure !! 'What To Expect From This Course' section has incorrect text " + "\n" + "Expected Text: "  
							+ "\n" + expectedtext + "\n" + 
							 "Actual Text : " + "\n" +  actualtext);
