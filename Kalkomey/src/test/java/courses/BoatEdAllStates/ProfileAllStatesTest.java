...
public class ProfileAllStatesTest
{
	...
	*/ 
	...
	private void Profile_UIElementVerification(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 1: Signing up as new User"); 
			...
			SeleniumFunc.ToGoToUrl(Constants.ApplicationURL + "/" + State1);
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage);
		Reporter.log("Step 1 : Navigate to Login page : " + Constants.ProfilePage); 
		...
		System.out.println("Step 4 : Verifying presence sections : 'Your Boat Ed Account' and 'Account Information' ");
		Reporter.log("Step 4 : Verifying presence sections : 'Your Boat Ed Account' and 'Account Information' "); 	
			
			if(SeleniumFunc.GetElementText("css", "div#main section:nth-of-type(1) h2").equals("Your Boat Ed Account"))
			{
				
				System.out.println("Success !! 'Your Boat Ed Account' section is present");
				Reporter.log("Success !! 'Your Boat Ed Account' section is present"); 
			}
			else
			{
				System.out.println("Failure !! 'Your Boat Ed Account' section is NOT present");
				Reporter.log("Failure !! 'Your Boat Ed Account' section is NOT present"); 
				AssertFailedCount++;
			}
	...
	/* Test 2: 
	 * Verify that 'Your Boat Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_YourBoaEdAccountSection(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 2 : Verify that 'Your Boat Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 2 : Verify that 'Your Boat Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"  + "\n" +
				 	  "====");	
		...
		System.out.println("Step 3 : Verifying 'Your Boat Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address");
		Reporter.log("Step 3 : Verifying 'Your Boat Ed Account' section has correct details i.e. Student Name, DOB, Username, Email Address"); 
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ResetPassword(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 5 : Verifying user is navigated to '/register/edit' page and proper confirmation message is dispalyed on that page");
			...
			if(SeleniumFunc.ToGetCurrentPageUrl().contains(Constants.ApplicationURL.subSequence(5,Constants.ApplicationURL.length())+ "/register/edit"))
			{
	...
	/* Test 4: 
	 * Verify user edit profile information successfully - editing Gender, Student SSN, Email Address, Mailing Address fields
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_Edit1(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 4 : Verify user edit profile information successfully - editing Gender, Student SSN, Email Address, Mailing Address fields"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 4 : Verify user edit profile information successfully - editing Gender, Student SSN, Email Address, Mailing Address fields"  + "\n" +
				 	  "====");	
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_Edit2(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_DefaultValues(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForInvalidEmail(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForInvalidZip(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForInvalidPhone(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	...
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_ValidationMessageForMandatoryFields(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_HideUnhidePhysicalAddress(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		System.out.println("Step 2 : Navigate to Profile page : " + Constants.ProfilePage);
		Reporter.log("Step 2 : Navigate to Profile page  : " + Constants.ProfilePage); 
	...
	*/ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void Profile_RegionLocalityFieldLabelChange(String State1) throws Exception
	{
		System.out.println("====" + "\n" +
