...
public class DashboardAllStatesTest 
{
	...
	*/ 
	...
	private void Dashboard_ResumeQuiz(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	*/ 
	@Test(dataProvider="RegistrationStates",dataProviderClass=utility.TestNG.class)
	private void Dashboard_ReLogin(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="RegistrationStates",dataProviderClass=utility.TestNG.class)
	private void Dashboard_CompleteApplication(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 4 : Verifying whether user is asked to 'Complete Registration and Payment' on login ");
			...
			String expectedtext = "Congratulations, you have successfully completed";
	 ...
	 * */ 
	@Test(dataProvider="RegistrationStates",dataProviderClass=utility.TestNG.class)
	private void Dashboard_VerifyAfterPayment(String State) throws Exception
	{
		System.out.println("====" + "\n" +
					"Test 4 :  Verify dashboard for user returning after payment"  + "\n" +
		 			"====");
		Reporter.log("====" + "\n" +
		 			  "Test 4 :  Verify dashboard for user returning after payment"  + "\n" +
				 	  "====");	
		...
		Reporter.log("Step 6 : Logout and login again , verifying dashboard"); 
			...
			//Verifying congratulation message
				...
				expectedtext = "Congratulations, you have successfully completed the ";
				...
				if(SeleniumFunc.IsElementPresent(coursecomplete.Download))
				{
				...
				if(SeleniumFunc.IsElementPresent(coursecomplete.Email))
				{
