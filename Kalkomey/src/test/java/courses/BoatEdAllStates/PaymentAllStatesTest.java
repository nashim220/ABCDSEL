...
public class PaymentAllStatesTest 
{
	...
	private void PaymentStage1_UI_Verification(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information , verfiying UI/Text information");
			...
			String expectedtext = "Your Application for the " +State+ " Boating Safety Education".toLowerCase();
			String actualtext = cerinfo.PageHeader.getText().toLowerCase();
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_Validation_MandatoryFields(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	...
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_Validation_InvalidInputs(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_RegionLocalityFieldLabelChange(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_ConfirmationPopUpDatails(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 4 : On Application page - Stage 1 : Certification Information ,  entering User info, Contact info.");
			...
			if(SeleniumFunc.IsElementPresent(cerinfo.Student_EyeColor))
			{
				cerinfo.SelectEyeColor("Blue");
			}
		
			if(SeleniumFunc.IsElementPresent(cerinfo.Student_HairColor))
			{
				cerinfo.SelectHairColor("Black");
			}
		
			if(SeleniumFunc.IsElementPresent(cerinfo.Student_SSN))
			{
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_ConfirmationPopUpDatails_Phy_Address(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_EditUpdateFields(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage1_NavigateToNextStage(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_UI_Verification(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , , verfiying UI/Text information");
			...
			String expectedtext = "Your Payment for the " +State +" Boating Course Certificate of Completion";
			...
			expectedtext = "Boat " +State+" Course Fee";
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_BillingAddress(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_Validation_MandatoryFields(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_Validation_InvalidInputs(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_ConfirmationPopUpDatails(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_ConfirmationPopUpDatails_SameAddress(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 6 : Clicking on 'Payment Cerification Information' button and verifying details on 'Confirm Your Payment Information' model");
			...
			//Verifying Acceptance Of Terms
			expectedtext = "Acceptance of Terms" + "\n" + 
							"I understand that I will be charged the total previously shown for the course fee and for my permanent Pennsylvania Boating Safety Education Certificate, and that there are no refunds or cancellations. I have agreed to these terms.";
			actualtext = payinfo.ConfirmPaymentInformationAcceptanceOfTerms_Header.getText().trim() + "\n" +
						 payinfo.ConfirmPaymentInformationAcceptanceOfTerms_Text.getText().trim()	;
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_PayWithCoupon(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_PayWithCreditCard(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage2_PaymentConfirmationEmail(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 6 : Navigating to Email Box and verifying whether payment confirmation email is received with correct details or not"); 
			...
			/*try
			{
				...
				String ExpectedMessageBody =
						"Hi test," + "\n" + "\n" +
						"Thank you for taking the Boat " + Constants.State.substring(1, Constants.State.length())+ " Course. Details of your payment appear below." + "\n" + "\n" + "\n" +
				...
				String ExpectedMessageBody1 =
						"Description: Boat " + Constants.State.substring(1, Constants.State.length())+ " Course" + "\n" + "\n" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage3_ViewReceiptPageDetails(String State) throws Exception
	{
		System.out.println("====" + "\n" +
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage3_NavigateToCourseCompeletePage(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 6 : On 'View Receipt' page, clicking on 'Get Your Proof of Home Study Voucher ' button"); 
			...
			if(actualtext.contains(expectedtext))
			{
				...
				expectedtext = "You Have Completed the "+State+" Boat Ed Course";
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void PaymentStage3_VerifyCourseCompeletePage(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 7 : On 'View Receipt' page, verifying details");
			...
			//Verifying congratulation message
				...
				expectedtext = "Congratulations, you have successfully completed the " +State+ " Boat Ed Course. You may now download your " +State+ " Temporary Boater Education Certificate or have it sent to your registered e-mail address.";
			...
			//Verifying presence of 'Download' button
				...
				expectedtext = "Download the "+State+" Temporary Boater Education Certificate";
			...
			//Verifying presence of 'Email' button
				...
				expectedtext = "E-mail the "+State+" Temporary Boater Education Certificate";
	 ...
	 * */ 
	@Test(dataProvider="Profile",dataProviderClass=utility.TestNG.class)
	private void BillingInfoPersistAfterCoupon(String State) throws Exception
	{
		System.out.println("====" + "\n" +
		...
		Reporter.log("Step 5 : On Payment Information page - Stage 2 , entering data for CC & selecting billing address=Mailing address and clicking on 'Confirm Payment Information' button");
			...
			new Select(payinfo.ExpirationMonth).selectByVisibleText("03");
			new Select(payinfo.ExpirationYear).selectByVisibleText("2018");
