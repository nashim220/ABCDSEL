...
public class CourseContentsAndQuizzesAllStatesTest 
{
	...
	*/ 
	...
	private void Contents_ContinueLeftOffButtonWorkingAsExpected(String State) throws Exception
	{
		...
		System.out.println("Step 6 : Navigating to Contents page and verifying whether  'Continue where you left off' button is displayed and on click to it, user is navigated to correct page");
		Reporter.log("Step 6 : Navigating to Contents page and verifying whether 'Continue where you left off' button is displayed and on click to it, user is navigated to correct page"); 
	...
	*/ 
	...
	private void Contents_NextButton_Timer_Tooltip(String State) throws Exception
	{
		...
		Reporter.log("Step 5 : Verifying whether tooltip is displayed on 'Next' button"); 
				...
				ActualText= SeleniumFunc.GetElementText("css", "div.popover-inner").trim();
				System.out.println(ActualText);
	...
	*/ 
	...
	Reporter.log("Step 8 : Clicking 'Back to the Quiz Results' button");
		...
		tempurl2="https://qa1.boat-ed.com/exam/quiz/";
		SeleniumFunc.ClickOnElement("css", "#prev_text a");
		Thread.sleep(4000);
		...
		//verifying page url
			...
			{
				System.out.println(" --- User is naviagated to Quiz page i.e. " + driver.getCurrentUrl() );
				Reporter.log("--- User is naviagated to Quiz page i.e. " + driver.getCurrentUrl());
			}
			else
			{
				System.out.println(" --- User is NOT naviagated to Quiz page i.e. " + driver.getCurrentUrl() );
				Reporter.log("--- User is NOT naviagated to Quiz page i.e. " + driver.getCurrentUrl());
				AssertFailedCount++;
			}
	...
	*/ 
	...
	private void Contents_ContentVerification(String State) throws Exception
	{
		...
		Reporter.log("Step 2 : On Contents page, verifying Page Header, Introduction Text, Units, Exams related text"); 
			...
			//Verifying Page header
				...
				String expected = State + " Boat Ed Course";
	...
	private void Contents_TimedCourseVerification(String State) throws Exception
	{
		...
		String username= "content" + JH.GenerateRandomNumber();
		String emailprefix = "content" + JH.GenerateRandomNumber();
		String emailaddress= emailprefix + "@mailinator.com";
		String password = "clarion@123";
